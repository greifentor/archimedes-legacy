 ...
 * @changed OLI 28.02.2010 - Korrekturen und Ma&szlig;nahmen zur Erh&ouml;hung der Testabdeckung.
...
public class Str {
	...
	public static String extractXMLStyleTagValue(String src, String tagname)
		...
		if ((start >= 0) && (end >= 0)) {
			...
			throw new NoSuchElementException(
					"Closing tag not found. May be tag (" + tagname + ") is not in a valid form!");
		}
		return result;
	}
	 ...
	 * @throws IllegalArgumentException Falls die Anzahl der Nachkommastellen kleiner als null ist.
	...
	public static String fixedDoubleToStr(double d, int nks) {
		...
		i = s.indexOf(".");
		/*
		 * OLI 28.02.2010 - Das kommt irgendwie niemals vor ... if (i < 0) { s += "."; for (k = 1; k <= nks; k++) { s +=
		 * "0"; } } else {
		 */
		j = s.length() - i;
		if (j < nks + 1) {
			...
			s = s.substring(0, i);
			/*
			 * OLI 28.02.2010 - Das auch nicht ... } else if (j > nks + 1) { s = s.substring(0, i + nks + 1);
			 */
		}
		// }
		return s;
	 ...
	 * @throws NullPointerException Falls der &uuml;bergebene String eine <TT>null</TT>-Referenz ist.
	 * @precondition html != <TT>null</TT>
	 *
	 * @changed OLI 05.09.2007 - Erweiterung um die Reaktion auf die Property
	 *          <TT>corentx.util.Str.suppress.html.note</TT>, die einen Hinweis auf eine Klasse mit besseren Methoden
	 ...
	 *          durch das Setzen der Property <I>corentx.util.Str.use.commons</I>.
	 */
...
//		}
		 ...
		 * replace(s, "&Ouml;", "�"); s = replace(s, "&radic;", "ø"); s = replace(s, "&Radic;", "Ø"); s = replace(s,
		 * "&szlig;", "�"); s = replace(s, "&uuml;", "�"); s = replace(s, "&Uuml;", "�"); s = replace(s, "&aacute;",
		 * "�"); s = replace(s, "&eacute;", "�"); s = replace(s, "&iacute;", "�"); s = replace(s, "&oacute;", "�"); s =
		 * replace(s, "&uacute;", "�"); s = replace(s, "&acirc;", "�"); s = replace(s, "&ecirc;", "�"); s = replace(s,
		 * "&icirc;", "�"); s = replace(s, "&ocirc;", "�"); s = replace(s, "&ucirc;", "�");
		 */
	 ...
	 *                                   String s liegt.
	 * @throws NullPointerException      Falls Der &uuml;bergebene String oder das einzuf&uuml;gende String-Fragment
	 *                                   <TT>null</TT> sind.
	 * @precondition s != <TT>null</TT> &amp;&amp; ins != <TT>null</TT> &amp;&amp; pos in [0..s.length()]
	 */
	public static String insert(String s, String ins, int pos) throws IndexOutOfBoundsException, NullPointerException {
		return s.substring(0, pos).concat(ins).concat(s.substring(pos, s.length()));
	}

	/**
	 * Pr&uuml;ft, ob der angegebene String eine <TT>null</TT>-Referenz oder ein leerer String ist.
	 *
	 * @return <TT>true</TT>, falls der angegebene String ein leerer String oder eine <TT>null</TT>-Referenz ist.
	 */
	...
	/**
	 * Liefert einen Teilstring vom angegebenen String, der von dessen Anfang bis zur angegebenen Sequenz reicht. Ist
	 * die angegebene Sequenz nicht vorhanden, wird der gesamte String zur&uuml;ckgegeben.
	 *
	 * @since 1.9.1
	 *
	 * @param s Der String, aus dem der Teilstring separiert werden soll.
	 * @param p Die Sequenz, die den String nach hinten begrenzt.
	 * @return Der Teilstring vom angegebenen String, der von dessen Anfang bis zur angegebenen Sequenz reicht. Ist die
	 *         angegebene Sequenz nicht vorhanden, wird der gesamte String zur&uuml;ckgegeben. Die begrenzende Sequenz
	 *         ist in dem Teilstring nicht mehr enthalten.
	 * @throws IllegalArgumentException Falls die Sequenz, die das Ende des Teilstring bestimmt als
	 *                                  <TT>null</TT>-Referenz oder leer &uuml;bergeben wird.
	 * @throws NullPointerException     Falls der String, aus dem der Teilstring gelesen werden soll als
	 *                                  <TT>null</TT>-Referenz &uuml;bergeben wird.
	 * @precondition s != <TT>null</TT>.
	 * @precondition p != <TT>null</TT> &amp;&amp; p.length() &gt; 0.
	 */
	public static String nextSubstring(String s, String p) throws IllegalArgumentException, NullPointerException {
		if ((p == null) || (p.length() < 1)) {
			throw new IllegalArgumentException("end sequence of substring can not be null or " + "empty.");
		}
		int pos = s.indexOf(p);
		if (pos > -1) {
			s = s.substring(0, pos);
	...
	/**
	 * Liefert einen Teilstring vom angegebenen String, der vom ersten Auftreten der angegebenen Sequenz bis zum Ende
	 * des Strings. Ist die angegebene Sequenz nicht vorhanden, wird der gesamte String zur&uuml;ckgegeben.
	 *
	 * @since 1.9.1
	 *
	 * @param s Der String, aus dem der Teilstring separiert werden soll.
	 * @param p Die Sequenz, ab der der Teilstring separiert werden soll.
	 * @return Der Teilstring vom angegebenen String, der vom ersten Auftreten der angegebenen Sequenz bis zum Ende des
	 *         Strings. Ist die angegebene Sequenz nicht vorhanden, wird der gesamte String zur&uuml;ckgegeben.
	 * @throws IllegalArgumentException Falls die Sequenz, die den Anfang des Teilstring bestimmt als
	 *                                  <TT>null</TT>-Referenz oder leer &uuml;bergeben wird.
	 * @throws NullPointerException     Falls der String, aus dem der Teilstring gelesen werden soll als
	 *                                  <TT>null</TT>-Referenz &uuml;bergeben wird.
	 * @precondition s != <TT>null</TT>.
	 * @precondition p != <TT>null</TT> &amp;&amp; p.length() &gt; 0.
	 */
	public static String nextTailString(String s, String p) throws IllegalArgumentException, NullPointerException {
		if ((p == null) || (p.length() < 1)) {
			throw new IllegalArgumentException("end sequence of substring can not be null or " + "empty.");
		}
		int pos = s.indexOf(p);
	 ...
	 * @throws NullPointerException  Falls der zu parsende String eine <TT>null</TT>-Referenz ist.
	 * @throws NumberFormatException Wenn sich der String nicht in eine g&uuml;ltige Zahl umrechnen l&auml;szlig;t
	 * @precondition s != <TT>null</TT>
	 */
	public static Number parseNumber(String s) throws NullPointerException, NumberFormatException {
		s = s.toLowerCase();
		if (s.endsWith("d")) {
	 ...
	 * @throws IllegalArgumentException Wenn eine falsche Richtung &uuml;bergeben wird (nicht LEFT oder RIGHT).
	 * @throws NullPointerException     Falls der aufzupumpende String oder die Erweiterung als <TT>null</TT>-Referenz
	 *                                  &uuml;bergeben werden.
	 * @precondition s != <TT>null</TT> &amp;&amp; e != <TT>null</TT> &amp;&amp; r != <TT>null</TT> &amp;&amp; (r ==
	 *               Direction.LEFT || r == Direction.RIGHT)
	 */
	 ...
	 * @param r  Die Richtung, in die der String aufgeblasen werden soll (LEFT oder RIGHT).
	 * @throws IllegalArgumentException Wenn eine falsche Richtung &uuml;bergeben wird (nicht LEFT oder RIGHT).
	 * @throws NullPointerException     Falls der aufzupumpende StringBuffer oder die Erweiterung als
	 *                                  <TT>null</TT>-Referenz &uuml;bergeben werden. Ebenfalls, wenn die Richtung als
	 *                                  <TT>null</TT>-Referenz &uuml;bergeben wird.
	 * @precondition sb != <TT>null</TT> &amp;&amp; e != <TT>null</TT> &amp;&amp; r != <TT>null</TT>
	 */
	...
	/**
	 * Liefert einen String der in die angegebenen Anf&uuml;hrungszeichen gesetzt ist, vorausgesetzt das die
	 * Anf&uuml;hrungszeichen angegeben werden. Mit "Anf&uuml;hrungszeichen" ist hier ein String gemeint, der dem
	 * angegebenen String voran- und nachgestellt wird.
	 *
	 ...
	 * @throws NullPointerException Falls einer der &uuml;bergebenen String eine <TT>null</TT>-Referenz ist.
	 * @precondition s != <TT>null</TT> &amp;&amp; p != <TT>null</TT> &amp;&amp; c != <TT>null</TT>
	 *
	 ...
	 *
	 * <P>
	 * Anstelle dieser Methode kann auch die Methode
	 * <TT>org.apache.commons.lang.StringUtils.replaceOnce(String, String, String)</TT> genutzt werden.
	 *
	 * @param s Der String, der als Grundlage f&uuml;r die Ersetzung dienen soll.
	 * @param p Das Muster, welches ersetzt werden soll.
	 * @param c Der Teilstring, der anstelle des Musters eingesetzt werden soll.
	...
	public static String spaces(int i) {
		...
		if (i < 0) {
			throw new IllegalArgumentException("method can not create a string with length " + "less than zero.");
		}
		while (i > 0) {
			sb.append(" ");
			i--;
	 ...
	 * @throws NullPointerException Falls der aufzuspaltende String oder das Trennzeichen als <TT>null</TT>-Referenz
	 *                              &uuml;bergeben werden.
	...
	/**
	 * Wandelt den angegebenen String in CamilCase-Schreibweise um. Die Trennzeichen werden dabei entfernt.
	 *
	 * @since 1.11.1
	 *
	 ...
	 * @throws NullPointerException Falls der umzuwandelnde String oder die Trennzeichen als <TT>null</TT>-Referenz
	 *                              &uuml;bergeben werden.
	 * @precondition delim != <TT>null</TT>.
	 * @precondition s != <TT>null</TT>.
	 *
	 * @changed OLI 28.10.2009 - Hinzugef&uuml;gt.
	 * @changed OLI 14.01.2010 - &Auml;nderung in der Art, da&szlig; Gro&szlig;buchstaben im Wort unangetastet bleiben.
	 */
	 ...
	 * @throws NullPointerException Falls der umzuwandelnde String als <TT>null</TT>-Pointer &uuml;bergeben wird.
	 * @precondition s != <TT>null</TT>.
	 *
	 * @changed OLI 05.09.2007 - Erweiterung um die Reaktion auf die Property
	 *          <TT>corentx.util.Str.suppress.html.note</TT>, die einen Hinweis auf eine Klasse mit besseren Methoden
	...
	public static String toHTML(String s) throws NullPointerException {
		...
		/*
		 * html = replace(html, "&", "&amp;"); html = replace(html, "�", "&auml;"); html = replace(html, "�", "&Auml;");
		 * html = replace(html, ">", "&gt;"); html = replace(html, "<", "&lt;"); // html = replace(html, " ", "&nbsp;");
		 * html = replace(html, "�", "&ouml;"); html = replace(html, "�", "&Ouml;"); html = replace(html, "ø",
		 * "&radic;"); html = replace(html, "Ø", "&Radic;"); html = replace(html, "�", "&szlig;"); html = replace(html,
		 * "�", "&uuml;"); html = replace(html, "�", "&Uuml;"); html = replace(html, "�", "&Uuml;"); html =
		 * replace(html, "�", "&aacute;"); html = replace(html, "�", "&eacute;"); html = replace(html, "�", "&iacute;");
		 * html = replace(html, "�", "&oacute;"); html = replace(html, "�", "&uacute;"); html = replace(html, "�",
		 * "&acirc;"); html = replace(html, "�", "&ecirc;"); html = replace(html, "�", "&icirc;"); html = replace(html,
		 * "�", "&ocirc;"); html = replace(html, "�", "&ucirc;");
		 */
		for (StrEntity se : StrEntity.values()) {
