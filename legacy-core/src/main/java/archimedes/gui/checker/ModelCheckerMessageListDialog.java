...
public class ModelCheckerMessageListDialog extends JDialogWithInifile
     ...
     * @changed OLI 11.07.2016 - Added.
     */
    public ModelCheckerMessageListDialog(Frame parent, GUIBundle guiBundle,
            ModelCheckerMessage[] mcms, boolean checkBeforeGenerate,
            ModelCheckerMessageListFrameListener... listeners) {
        super(parent, guiBundle.getResourceText(RES_MODEL_CHECKER_LIST_FRAME_TITLE),
                guiBundle.getInifile());
        this.setContentPane(new ModelCheckerMessageListPanel(guiBundle, mcms,
                checkBeforeGenerate, this, listeners));
        this.pack();
