...
abstract public class CopyAndPasteController {
    ...
    /**
     * Converts tables form a transferable format table data and add them to the passed data
     * model.
     *
     ...
     * @changed OLI 08.12.2016 - Added.
     */
    public TableModel[] transferableStringToTable(DataModel dm, ObjectFactory objectFactory,
        ...
        return new ModelXMLReader(objectFactory).readTables(dm, (NodeList) xpath.evaluate(
                "/Tables/Table", doc, XPathConstants.NODESET));
    }
     ...
     * @changed OLI 08.12.2016 - Added.
     */
    abstract public TableModel[] transferableStringToTable(DataModel dm, String s)
            throws Exception;
