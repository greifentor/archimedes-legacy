 ...
 *
 * @changed
 *     OLI 01.01.2008 - Anpassungen an die Erweiterung der Signatur der paint-Methode der Klasse
...
public class CPJDiagramm extends CorePrintJob {
    ...
    public CPJDiagramm(JobAttributes ja, PageAttributes pa, DiagramComponentPanel comp) {
        ...
        this.diagramm = new BufferedImage(comp.getImgWidth(), comp.getImgHeight(),
     ...
     *
     * @changed
     *     OLI 01.01.2008 - Anpassungen an die Erweiterung der Signatur der paint-Methode der 
     *             Klasse ComponentDiagramm.<BR>
     */
    @Override public void paint(Graphics g, int page) {
