...
/**
 * A class code generator for file based localization resource manager impl classes.
 *
 * @author ollie (07.01.2022)
 */
public class FileBasedResourceManagerImplClassCodeGenerator extends AbstractClassCodeGenerator<LocalizationNameGenerator> {

	public FileBasedResourceManagerImplClassCodeGenerator(AbstractCodeFactory codeFactory) {
		super(
				"FileBasedResourceManagerImplClass.vm",
	...
	protected void extendVelocityContext(VelocityContext context, DataModel model, TableModel table) {
		...
		context.put("ResourceManagerPackageName", nameGenerator.getResourceManagerPackageName(model, table));
	}
