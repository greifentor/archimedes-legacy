 ...
 */
public class MasterDataGUIConfigurationClassCodeGenerator extends AbstractModelCodeGenerator<GUIVaadinNameGenerator> {

	public MasterDataGUIConfigurationClassCodeGenerator(AbstractCodeFactory codeFactory) {
		super(
				"masterdata/MasterDataGUIConfigurationClass.vm",
	...
	public String getClassName(DataModel model, DataModel sameModel) {
		return nameGenerator.getMasterDataGUIConfigurationClassName(model);
	}
