 ...
 */
public class TextFieldFactoryClassCodeGenerator extends AbstractModelCodeGenerator<GUIVaadinNameGenerator> {

	public TextFieldFactoryClassCodeGenerator(AbstractCodeFactory codeFactory) {
		super(
				"component/TextFieldFactoryClass.vm",
	...
	public String getClassName(DataModel model, DataModel sameModel) {
		return nameGenerator.getTextFieldFactoryClassName(model);
	}
