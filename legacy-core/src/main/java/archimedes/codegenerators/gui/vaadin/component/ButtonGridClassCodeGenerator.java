...
/**
 * A generator for ButtonGrid classes.
 * 
 * @author ollie (19.12.2022)
 *
 */
public class ButtonGridClassCodeGenerator extends AbstractModelCodeGenerator<GUIVaadinNameGenerator> {

	public ButtonGridClassCodeGenerator(AbstractCodeFactory codeFactory) {
		super(
				"component/ButtonGridClass.vm",
	...
	public String getClassName(DataModel model, DataModel sameModel) {
		return nameGenerator.getButtonGridClassName(model);
	}
