 ...
 */
public class DetailsLayoutComboBoxItemLabelGeneratorInterfaceCodeGenerator extends AbstractModelCodeGenerator<GUIVaadinNameGenerator> {

	public DetailsLayoutComboBoxItemLabelGeneratorInterfaceCodeGenerator(AbstractCodeFactory codeFactory) {
		super(
				"masterdata/DetailsLayoutComboBoxItemLabelGeneratorInterface.vm",
	...
	public String getClassName(DataModel model, DataModel sameModel) {
		return nameGenerator.getDetailsLayoutComboBoxItemLabelGeneratorInterfaceName(model);
	}
