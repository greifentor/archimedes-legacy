...
public class ServiceProviderClassCodeGenerator extends AbstractModelCodeGenerator<GUIVaadinNameGenerator> {

	public ServiceProviderClassCodeGenerator(AbstractCodeFactory codeFactory) {
		super(
				"component/ServiceProviderClass.vm",
	...
	public String getClassName(DataModel model, DataModel sameModel) {
		return nameGenerator.getServiceProviderClassName(model);
	}
