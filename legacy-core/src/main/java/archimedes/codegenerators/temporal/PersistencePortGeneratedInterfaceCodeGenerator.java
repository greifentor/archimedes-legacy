...
/**
 * A class code generator for persistence port interface in a temporal data
 *
 * @author ollie (25.04.2021)
 */
public class PersistencePortGeneratedInterfaceCodeGenerator
		extends AbstractClassCodeGenerator<TemporalDataNameGenerator> {

	public PersistencePortGeneratedInterfaceCodeGenerator(AbstractCodeFactory codeFactory) {
		super(
				"PersistencePortGeneratedInterface.vm",
	...
	public String getClassName(TableModel table) {
		return nameGenerator.getPersistencePortGeneratedInterfaceName(table);
	}
