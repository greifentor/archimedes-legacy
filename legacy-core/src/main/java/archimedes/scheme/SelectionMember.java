...
public class SelectionMember implements Attributed, Editable, SelectionMemberModel {
     ...
     * @param printExpression The print expression for the selection member (or
     *         <CODE>null</CODE> or an empty String if none is defined for the selection
     *         member).
     *
     * @changed OLI 30.12.2015 - Added.
     * @changed OLI 02.08.2016 - Added the parameter "printExpression".
     */
    public SelectionMember(ColumnModel column, SelectionAttribute attribute, 
     ...
     * @changed OLI 20.08.2013 - Added.
     */
    @Override public Object createObject(Object blueprint) throws ClassCastException {
     ...
     * @changed OLI 20.08.2013 - Added.
     */
    @Override public Object get(int id) throws IllegalArgumentException {
        switch (id) {
        case ID_ATTRIBUTE:
        ...
        throw new IllegalArgumentException("Class SelectionMember doesn't owns an attribute: "
                + id + " (get)!");
    }
     ...
     * @changed OLI 20.08.2013 - Added.
     */
    @Override public SelectionAttribute getAttribute() {
     ...
     * @changed OLI 20.08.2013 - Added.
     */
    @Override public ColumnModel getColumn() {
        return this.column;
    }
     ...
     */
    @Override public String getPrintExpression() {
     ...
     * @changed OLI 20.08.2013 - Added.
     */
    @Override public EditorDescriptorList getEditorDescriptorList() {
        DefaultEditorDescriptorList dedl = new DefaultEditorDescriptorList();
        List<ColumnModel> columns = Arrays.asList(this.getColumn().getTable().getDataModel(
                ).getAllColumns());
        DefaultComponentFactory dcfcol = new DefaultComponentFactory(columns);
        DefaultComponentFactory dcfdir = new DefaultComponentFactory(Arrays.asList(
                SelectionAttribute.values()));
        DefaultComponentFactory dcf = DefaultComponentFactory.INSTANZ;
        DefaultLabelFactory dlf = DefaultLabelFactory.INSTANZ;
        dedl.addElement(new DefaultEditorDescriptor(0, this, ID_COLUMN, dlf, dcfcol, 
                "Tabellenspalte", 'T', null, StrUtil.FromHTML("Die Tabellenspalte, die in der "
                + "Auswahl angezeigt werden soll."), true));
        dedl.addElement(new DefaultEditorDescriptor(0, this, ID_ATTRIBUTE, dlf, dcfdir, 
                "Attribut", 'A', null, StrUtil.FromHTML("Das Attribut zur Tabellenspalte.")));
        dedl.addElement(new DefaultEditorDescriptor(0, this, ID_PRINT_EXPRESSION, dlf, 
                dcf, "Print expression", 'P', null, StrUtil.FromHTML("A print expression for "
     ...
     * @changed OLI 20.08.2013 - Added.
     */
    @Override public void set(int id, Object value) throws ClassCastException,
     ...
     * @changed OLI 20.08.2013 - Added.
     */
    @Override public void setAttribute(SelectionAttribute attribute) {
        this.attribute = attribute;
    }
     ...
     * @changed OLI 20.08.2013 - Added.
     */
    @Override public void setColumn(ColumnModel column) {
        this.column = column;
    }
     ...
     * @changed OLI 02.08.2016 - Added.
     */
    @Override public void setPrintExpression(String printExpression) {
        this.printExpression = printExpression;
    }
