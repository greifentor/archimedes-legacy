 ...
 * <P>TO have an own variant of the code factory create a class which implements this interface
 * and include the class as code factory in the data model which should use it.
 *
 * @author O.Lieshoff
 *
...
public interface CodeFactory {
    ...
    /**
     * Adds the passed listener to the list of listeners which are observing the
     * IsisCodeFactory.
     *
    ...
    /**
     * Removes the passed listener from the list of listeners which are observing the
     * IsisCodeFactory.
     *
    ...
    /**
     * Sets the passed model checker message list frame listener in case of errors or warnings
     * are detected.
     *
