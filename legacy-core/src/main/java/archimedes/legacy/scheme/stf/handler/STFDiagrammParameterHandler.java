...
public class STFDiagrammParameterHandler extends AbstractSTFHandler {
	...
	public static final String DB_VERSION_DESCRIPTION_COLUMN_NAME = "DBVersionDescriptionColumn";
	...
	public static final String DOMAIN_SHOW_MODE = "DomainShowMode";
	 ...
	 *
	 * @param additionalIds The additional id's which are following the id header for list elements.
	 *
	 * @changed OLI 26.04.2013 - Added.
	 */
	 ...
	 */
	@Override
	public String getSingleListElementTagId() {
		return PARAMETER;
	}
	 ...
	 */
	@Override
	public String getWholeBlockTagId() {
		return PARAMETER;
	}
