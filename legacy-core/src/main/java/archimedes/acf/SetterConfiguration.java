...
public class SetterConfiguration {
     ...
     *
     * @return <CODE>true</CODE> if the setters should override other setters or interface
     *         specifications.
     *
     * @changed OLI 02.05.2016 - Added.
     */
    ...
    /**
     * Sets the flag for the overriden mode.
     *
     * @return The modified setter configuration.
     *
     * @changed OLI 02.05.2016 - Added.
     */
    public SetterConfiguration setOverriden() {
        this.overriden = true;
        return this;
    }
