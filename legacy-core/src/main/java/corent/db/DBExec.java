...
/**
 * Diese Klasse kapselt die Zugriff auf die Datenbank und erm&ouml;glicht auf
 * diese Weise die Nutzung von Software unter verschiedenartigen DBMS. <BR>
 * <HR SIZE=3>
 * <H3>Funktionsweise</H3>
 * <HR SIZE=1>
 * <P>
 * Mit Hilfe des <TT>JDBCDataSourceRecord</TT> k&ouml;nnen die Daten f&uuml; den
 * Zugriff konfiguriert werden. Diese Klasse ist ebenfalls ein Teil des
 * <TT>corent.db</TT>-Packages, zu dem auch <TT>DBExec</TT> geh&ouml;rt.<BR>
 * <I>Beispiel:</I>
 * 
 * <PRE>
 * JDBCDataSourceRecord jdbcsr = new JDBCDataSourceRecord("com.microsoft.jdbc.sqlserver.SQLServerDriver",
 * 		"jdbc:microsoft:sqlserver://testeumel:1433;DatabaseName=TestDB", "bmustermann", "geheim");
 * </PRE>
 * <P>
 * Mit Hilfe eines vorkonfigurierten <TT>JDBCDataSourceRecord</TT> kann nun ein
 ...
 *
 * <P>
 * Anschlie&szlig;end kann mit der Klasse <TT>DBExec</TT> &uuml;ber die Methode
 * <TT>Query</TT> eine Abfrage initiiert werden, oder &uuml;ber die Methode
 * <TT>Update</TT> eine &Auml;nderung an der Datenbank (sowohl Schema als auch
 ...
 *
 * <P>
 * Das <TT>ResultSet</TT> l&auml;&szlig;t sich mit den gewohnten Methoden
 * bearbeiten. Nach dem Auslesen der Daten sollte das <TT>ResultSet</TT>
 * &uuml;ber die Methode <TT>DBExec.CloseQuery(rs)</TT> abgeschlossen werden.
 * Dies funktioniert dann auch datenbanken&uuml;bergreifend.
 * <P>
 * &Auml;nderungen werden, wie bereits angedeutet, mit Hilfe der Methode
 * <TT>Update</TT> aus der Klasse <TT>DBExec</TT> in die Datenbank eingebracht
 * werden.<BR>
 * <I>Beispiel:</I>
 * 
 * <PRE>
 ...
 *
 * <P>
 * Um Datenbankenabfragen zu erzeugen die
 * <B>datenbanksystem&uuml;bergreifend</B> funktionieren, gibt es in der Klasse
 * <TT>DBExec</TT> einen Satz von Methoden, die diesem Ziel zuarbeiten. Um
 * beispielsweise ein Query zu erzeugen, dessen Trefferzahl limitiert werden
 ...
 *
 * <P>
 * Zu &auml;hnlichen Zwecken stehen in DBExec-Klasse die Methoden
 * <TT>Concatenation</TT>, <TT>Convert</TT>, <TT>LowerCase</TT> und
 * <TT>Truncate</TT> zur Verf&uuml;gung.
 * <P>
 * Die Anpassungen, die durch diese Methoden durchgef&uuml;hrt werden, richten
 * sich nach dem f&uuml;r die DBExec-Klasse eingestellten DBExecMode. Dieser
 * kann explizit &uuml;ber die Methode SetMode gesetzt werden.<BR>
 * <I>Beispiel:</I>
 * 
 * <PRE>
 ...
 * <TD>false</TD>
 * <TD>Boolean</TD>
 * <TD>Durch Setzen dieser Property l&auml;&szlig;t sich der Aufruf der
 * <TT>isnull</TT> im generierten Convert-Statement bei Betrieb im MSSQL- und
 * HSQL-Modus zu erzwingen.</TD>
 * </TR>
 * <TR VALIGN=TOP>
 * <TD>corent.db.DBExec.PrintTimestamp</TD>
 * <TD>false</TD>
 * <TD>Boolean</TD>
 * <TD>Diese Property kann gesetzt werden, um die Ausgabe eines Zeitstempels vor
 * jedem Statement zu erreichen. Die Option funktioniert nur im Zusammenspiel
 * mit dem Setzen der Property <TT>corent.db.DBExec.ShowStatements</TT>.</TD>
 * </TR>
 * <TR VALIGN=TOP>
 * <TD>corent.db.DBExec.ShowStatements</TD>
 * <TD>false</TD>
 * <TD>Boolean</TD>
 * <TD>Durch das Setzen dieser Property werden die von DBExec an das DBMS
 * &uuml;bertragenen Statements &uuml;ber <TT>System.out</TT> angezeigt.</TD>
 * </TR>
 * <TR VALIGN=TOP>
 * <TD>corent.db.DBExec.suppress.output.faulty.statements
 * <TD>false</TD>
 * <TD>Boolean</TD>
 * <TD>Durch das Setzen dieser Property wird die Ausgabe fehlgeschlagener
 * Statements unterdr&uuml;ckt.</TD>
 * </TR>
 * <TR VALIGN=TOP>
 * <TD>corent.db.DBExec.suppress.warnings</TD>
 * <TD>false</TD>
 * <TD>Boolean</TD>
 * <TD>Durch das Setzen dieser Property werden Warnungen (z. B., da&szlig; die
 * eine oder andere Methode f&uuml;r einen bestimmten Modus noch nicht
 * implementiert ist ;o) unterdr&uuml;ckt.</TD>
 * </TR>
 * <TR VALIGN=TOP>
 * <TD>corent.db.DBExecMode.version</TD>
 * <TD><TT>null</TT></TD>
 * <TD>String</TD>
 * <TD>Diese Property wird im Zusammenhang mit der Convert-Methode genutzt.
 * Hintergrund war eine ge&auml;nderte Syntax im Konvertieren bei mySQL 5.x.
 * </TD>
 * </TR>
 * </TABLE>
 * <P>
 * <P>
 * <B>HINWEIS</B>: Die Implementierung von PostgreSQL-Datenbanken ist noch
 * relativ frisch! Daher sollte beim Betrieb in diesem Modus mit ausreichendem
 * Test Aufwand einhergehen.
 *
 * @author O.Lieshoff
 *
 * @changed OLI 01.03.2004 - Hinzugef&uuml;gt.
 * @changed OLI 05.09.2007 - Erg&auml;nzung der Dokumentation.
 * @changed OLI 13.09.2007 - Einbau der Test und Beispiel-Routine in der
 *          <TT>main</TT>-Methode. Erweiterung der Methoden
 *          <TT>LowerCase(String)</TT> und <TT>UpperCase(String)
 *         </TT> um die Unterst&uuml;tzung des DBExecMode.MSSQL.
 * @changed OLI 10.10.2007 - Korrektur des fehlerhaften Italic-Tags in der
 *          Klassendokumentation.
 * @changed OLI 08.11.2007 - Das Abfangen von Null-Feldern wird nun unter
 *          PostgreSQL f&uuml;r jedes Element der Concatenation in der Methode
 *          <TT>concatenation(Vector, String)</TT> abgefangen.
 * @changed OLI 20.01.2009 - Erweiterung um eine Methode zum Lesen der aktuellen
 *          Systemzeit des Datenbankensystems.
 * @changed OLI 27.04.2009 - Erweiterung um die Ausgabe des Statements im Falle
 *          einer SQLException in den Methoden <TT>query</TT> und
 *          <TT>update</TT>.
 * @changed OLI 19.06.2009 - Formatanpassungen und Umstellung der Ausgaben auf
 *          log4j. Die Messages gehen fort an auf dem <TT>info</TT>-Level ins
 *          log.
 * @changed OLI 27.04.2011 - Erweiterung um den Betrieb mit dem
 *          <TT>DBExecListenern</TT>.
 * @changed OLI 27.05.2011 - M&ouml;glichkeit der Unterdr&uuml;ckung der Ausgabe
 *          eines fehlgeschlagenen Statements in den Methoden <TT>update</TT>
 *          und <TT>query</TT>.
 */
...
public class DBExec {
	...
	/*
	 * Das Hinzuf&uuml;gen eines neuen Modus erfordert &Auml;nderungen in den
	 * Methoden closeQuery, concatenation, convert, limitQuery und truncate.
	 */

	/**
	 * Name der Property zur Unterd&uuml;ckung der Ausgabe eines fehlerhaften
	 * Statements in der update- und der query-Methode.
	 *
	 * @changed OLI 27.05.2011 - Hinzugef&uuml;gt.
	 */
	public static final String PROP_NAME_SUPPRESS_FAULTY_STATEMENTS = "corent.db.DBExec.suppress.output.faulty.statements";

	/**
	 * &Uuml;ber diese Flagge kann die Ausgabe eines Zeitstempels vor jedem
	 * Statement veranla&szlig;t werden.
	 */
	public static boolean PrintTimestamp = Boolean.getBoolean("corent.db.DBExec.PrintTimestamp");
	/**
	 * Flagge, die &uuml;ber die Anzeige der Statements entscheidet <I>(Default wird
	 * gesetzt) durch die Property "corent.db.DBExec.ShowStatements")</I>. / public
	 * static boolean ShowStatements =
	...
	/**
	 * Generiert eine Instanz der DBExec-Klasse und initialisiert diese mit dem
	 * &uuml;bergebenen DBExecMode.
	 *
	 * @param dbm Der DBExecMode, mit dem die Instanz von DBExec initialisiert
	 *            werden soll.
	 */
	...
	/**
	 * F&uuml;gt den angegebenen DBExecListener an die Liste der DBExecListener an,
	 * die die Ereignisse der DBExec-Instanz abh&ouml;ren sollen.
	 *
	 ...
	 *
	 * @param message Die Meldung, die nach dem Header auf die Konsole gedruckt
	 *                werden soll.
	 */
	 ...
	 *
	 * @param connection Connection, &uuml;ber die das angegebene Statement
	 ...
	 * @throws SQLException falls bei der Ausf&uuml;hrung des Statements ein Fehler
	 *                      auftritt.
	 */
	 ...
	 * @changed OLI 27.04.2009 - Erweiterung um die Ausgabe des Statements im Falle
	 *          einer SQLException.
	 * @changed OLI 27.05.2011 - Herausnahme der Stacktrace-Ausgabe im Falle einer
	 *          SQLException. Diese Exception wird ohnehin weitergeleitet. Die
	 *          Ausgabe kann durch die Kundenklasse erfolgen.
	 */
	 ...
	 *                      auftritt.
	 */
	public static ResultSet Query(Connection connection, String statement, long limit) throws SQLException {
	 ...
	 *
	 */
	public ResultSet query(Connection connection, String statement, long limit) throws SQLException {
		long millis = System.currentTimeMillis();
		ResultSet rs = null;
		Statement stmt = null;
		if (limit > 0) {
	...
	/**
	 * L&ouml;scht den angegebenen DBExecListener aus der Liste der DBExecListener,
	 * die die Ereignisse der DBExec-Instanz abh&ouml;ren sollen.
	 *
	 * @param dbl Der DBExecListener, der von der DBExec-Instanz abgetrennt werden
	 *            soll.
	...
	/**
	 * Pr&uuml;ft, ob die Statements im Betrieb der statischen Instanz ausgegeben
	 * werden sollen.
	 *
	...
	/**
	 * Mit Hilfe dieser Methode kann ein Konkatenierungsausdruck f&uuml;r die in dem
	 * Vector &uuml;bergebenen Strings gebildet werden. Der tats&auml;chlich
	 * gebildete Ausdruck wird entsprechend des Betriebsmodus an die Syntax der
	 * verwendeten Datenbank angepa&szlig;t.
	 * <P>
	 * Werden in dem Vector Objekte anderer Klassen als String &uuml;bergeben, so
	 * werden sie &uuml;ber ihre <TT>toString()</TT>-Methoden angepa&szlig;t.
	 *
	 ...
	 *
	 * @changed OLI 08.11.2007 - Das Abfangen von Null-Feldern wird nun unter
	 *          PostgreSQL f&uuml;r jedes Element der Concatenation abgefangen.
	 */
	...
	/**
	 * Erweitert das &uuml;bergebene Select-Statement um eine Klausel, die die
	 * Anzahl der zu selektierenden Datens&auml;tze begrenzt.
	 *
	 * @param statement Das zu erweiternde Select-Statement.
	 * @param limit     Die maximale Anzahl der Datens&auml;tze, selektiert werden
	 *                  sollen.
	 */
	 ...
	 *
	 * @changed OLI 13.09.2007 - Erweiterung um den Warnhinweis, bei Nutzung der
	 *          Methode im DBExecMode.HSQL.
	 *
	 */
	...
	/**
	 * Diese Methode erzeugt f&uuml;r den angegebenen Ausdruck s eine Umwandlung in
	 * die Kleinbuchstaben (z. B. LOWER-Funktion).
	 *
	...
	/**
	 * Diese Methode erzeugt f&uuml;r den angegebenen Ausdruck s eine Umwandlung in
	 * die Gro&szlig;buchstaben (z. B. UPPER-Funktion).
	 *
	 * @param s Der Ausdruck, f&uuml;r den der Funktionsaufruf erzeugt werden soll.
	 */
	...
	/**
	 * Diese Methode erzeugt eine datenbankspezifische Typkonvertierungsklausel zu
	 * den &uuml;bergebenen Parametern.
	 *
	 * @param type  Der Typ, in den der angegebene Wert konvertiert werden soll.
	 * @param value Der Wert im String-Format, der umgewandelt werden soll. Handelt
	 *              es sich tats&auml;chlich um einen String, so mu&szlig; dieser in
	...
	/**
	 * Diese Methode erzeugt eine datenbankspezifische Typkonvertierungsklausel zu
	 * den &uuml;bergebenen Parametern. Im Falle einer Umwandlung in den Typ VARCHAR
	 * und NUMERIC, k&ouml;nnen hier Angaben zur L&auml;nge des Feldes und zur
	 ...
	 *              es sich tats&auml;chlich um einen String, so mu&szlig; dieser in
	 *              Hochkommata gesetzt werden.
	 * @param len   L&auml;nge des Zieltyps. Dieser Parameter ist nur bei
	 *              Umwandlungen in VARCHAR und NUMERIC relevant.
	 * @param nks   Die Nachkommastellen des Zieltyps. Dieser Parameter ist nur bei
	 *              Umwandlungen in NUMERIC relevant.
	 */
	...
	/**
	 * Liefert zu eine angegebenen java.sql.Types-Konstante einen String mit dem
	 * SQL-Typnamen.
	 *
	 * @param typ Die java.sql.Types-Konstante, zu der der Namen geliefert werden
	 *            soll.
	 * @param len Die L&auml;nge des Datenfeldes oder 0, falls keine L&auml;nge
	 *            erforderlich ist.
	 * @return Der besagte Name bzw. <TT>"unknown"</TT>, wenn die Konstante nicht
	 *         bekannt ist.
	 */
	 ...
	 *
	 * @param type Ein g&uuml;ltiger java.sql.Types-Wert, zu dem der String
	...
	/**
	 * Pr&uuml;ft, ob der angegebene, numerische Wert dem boolschen Wert f&uuml;r
	 * <TT>true</TT> entspricht (0 = false, alles andere ist true).
	 *
	 * @return <TT>true</TT>, wenn der &uuml;bergegebene Zahlenwert dem boolschen
	 *         Wert TRUE entspricht (i != 0), bzw. <TT>false</TT>, wenn er diesem
	 *         nicht entspricht (i == 0).
	 */
	 ...
	 * G&auml;nsef&uuml;&szlig;chen werden entfernt; null-Referenzen in "NULL"
	 * umgewandelt. Der String wird zudem um einschliessende Hochkommata erweitert,
	 * soda&szlig; er direkt in ein SQL-Statement eingebaut werden kann.
	 *
	 * @param s Ein String.
	 * @return Ein g&uuml;ltiger SQL-String-Wert mit dem Inhalt des &uuml;bergebenen
	 *         String s.
	 */
	 ...
	 *
	 * <I><B>Hinweis:</B> Die Methode ist derzeit nicht f&uuml;r HSQL
	 * implementiert.</I>
	 *
	 ...
	 * @throws <TT>ParseException</TT> falls der aus der Datenbank gelesene
	 * Datumswert nicht in einen PTimestamp umgewandelt werden kann.
	 * @throws <TT>SQLException</TT> falls beim Lesen der Zeit ein Fehler in der
	 * Kommunikation mit dem DBMS auftritt.
	 * @throws <TT>UnsupportedOperationException</TT> falls die Methode im
	 * HSQL-Modus aufgerufen wird.
	 *
	...
	public PTimestamp getSystemTime(Connection c) throws Exception {
		...
		String s = null;
		if (this.dbmode == DBExecMode.HSQL) {
			throw new UnsupportedOperationException("getSystemTime() is not yet implemented for" + " HSQL!");
		}
		if (this.dbmode == DBExecMode.MSSQL) {
			rs = DBExec.Query(c,
					"select convert(bigint, datepart(yyyy, GetDate())"
	...
	/**
	 * Diese Methode liefert f&uuml;r den angegebenen Ausdruck einen zum DBExecMode
	 * passenden Truncate-Ausdruck.
	 *
