...
/**
 * Mit Hilfe dieser Implementierung eines typsicheren Enum werden die Betriebsmodi f&uuml;r DBExec repr&auml;sentiert.
 *
 * @author O.Lieshoff
 *
 ...
 *         DBExecMode)</TT>. Mit ihrer Hilfe k&ouml;nnen DBExecModes bequem aus den Properties gelesen werden.<BR>
 * @changed OLI 07.06.2011 - Erweiterung um das Teststatement zur Pr&uuml;fung der Funktion des DBMS. Umwandlung in eine
 *          echte Enum-Klasse.
 * @changed OLI 29.08.2023 - Erweiterung um den Oracle-Modus.
 */
...
public enum DBExecMode {
	...
	/** Ein Modusbezeichner f&uuml;r ORACLE-Datenbanken. */
	ORACLE("Oracle-Modus", "ORACLE", null),
	...
	/**
	 * Liest einen DBExecMode aus der Property mit dem angegebenen Namen. Die Property mu&szlig; das Token (den Namen
	 * des DBExecMode-Bezeichners) enthalten.
	 *
	 * @param pn   Name der Property, aus der der DBExecMode gelesen werden soll.
	 * @param dflt Ein DBExecMode, der als Default zur&uuml;ckgeliefert wird, falls die Property keine g&uuml;ltigen
	 *             Daten f&uuml;r einen DBExecMode enth&auml;lt.
	 * @return Der DBExecMode, der sich aus den in der Property angegebenen Daten ergibt, bzw. der angegebene
	 *         Defaultwert, falls die Property keine g&uuml;ltigen Daten f&uuml;r einen DBExecMode enth&auml;lt.
	 *
	 * @changed OLI 04.09.2007 - Hinzugef&uuml;gt.
	 */
	...
	/**
	 * Liefert ein K&uuml;rzel zum Modus. Dieses K&uuml;rzel kann auch mit Hilfe der valueOf-Methode wieder in einen
	 * Modus verwandelt werden.
	 *
