...
/**
 * Diese Erweiterung der JDialog-Klasse erm&ouml;glicht die Anbindung einer Ini-Datei an einen
 * JDialog. Die Gr&ouml;&szlig;eneinstellungen werden rekonstruiert bzw. gespeichert.
 *
 * @author O.Lieshoff
 * 
 */

public class JDialogWithInifile extends JDialog implements ComponentWithInifile,
        ContextOwner {
    ...
    /* &Uuml;berschreibungen der Konstruktoren der Basisklasse. */

    public JDialogWithInifile(Inifile ini) {
        super();
        this.setInifile(ini);
    }

    public JDialogWithInifile(Dialog owner, boolean modal, Inifile ini) {
        super(owner, modal);
        this.setInifile(ini);
    }

    public JDialogWithInifile(Dialog owner, String title, boolean modal, Inifile ini) {
        super(owner, title, modal);
        this.setInifile(ini);
    }

    public JDialogWithInifile(Dialog owner, String title, Inifile ini) {
        super(owner, title);
        this.setInifile(ini);
    }

    public JDialogWithInifile(Dialog owner, Inifile ini) {
        super(owner);
        this.setInifile(ini);
    }

    public JDialogWithInifile(Frame owner, boolean modal, Inifile ini) {
        super(owner, modal);
        this.setInifile(ini);
    }

    public JDialogWithInifile(Frame owner, String title, boolean modal, Inifile ini) {
        super(owner, title, modal);
        this.setInifile(ini);
    }

    public JDialogWithInifile(Frame owner, String title, Inifile ini) {
        super(owner, title);
        this.setInifile(ini);
    }

    public JDialogWithInifile(Frame owner, Inifile ini) {
        super(owner);
        this.setInifile(ini);
    }
        ...
        if (b) {
            ...
            if (this.ini != null) {
                ...
                try {
                    ...
                    this.ini.writeBool(this.getIdentifier(), "BruteRestore", 
                            this.isBruteRestore());
