...
/**
 * Mit Hilfe dieser Klasse kann ermittelt werden, ob es sich bei einem angegebenen Datum um einen Feiertag handelt. Die
 * Standardeinstellung gilt f&uuml;r Berlin.
 *
 *
 * <H2>Konfiguration &uuml;ber Datei</H2>
 *
 * <P>
 * Die Feiertagsklasse kann durch eine Konfigurationsdatei um weitere Feiertage erweitert werden oder sogar mit
 * vollkommen neuen Feiertagen konfiguriert werden. Es handelt sich um eine Textdatei die folgendes Format akzeptiert:
 * <TABLE BORDER=1>
 * <TR>
 * <TD>Kommando</TD>
 * <TD>Beschreibung</TD>
 ...
 * <TR>
 * <TD>"#" Kommentar</TD>
 * <TD>Beginnt eine Zeile der Datei mit der Raute, so wird sie als Kommentar &uuml;bersprungen</TD>
 * </TR>
 * <TR>
 * <TD>"clear"</TD>
 * <TD>L&ouml;scht die bereits definierten Feiertagsregeln. Geben Sie dieses Kommando immer am Anfang der Datei. Davor
 * in der Datei angegebene Regeln werden ebenfalls zur&uuml;ckgesetzt.</TD>
 * </TR>
 * <TR>
 * <TD>"os" TT.MM.JJJJ Bezeichnung</TD>
 * <TD>Legt einen Feiertag fest, zu dem andere Feiertage in Beziehung gesetzt werden k&ouml;nnen (variable Feiertage).
 * In der westlichen Welt wird es sich normalerweise um den Ostersonntag handeln.</TD>
 * </TR>
 * <TR>
 * <TD>"vf" Tage Bezeichnung</TD>
 * <TD>Definition eines variablen Feiertages. Die Angabe der Tage ist das Offset zum definierten "Ostersonntag".
 * F&uuml;r variable Feiertage, die vor dem Bezugsfeiertag liegen, wird hier ein negativer Wert angegeben.</TD>
 * </TR>
 * <TR>
 * <TD>"ff" TT MM Bezeichnung</TD>
 * <TD>Angabe eines festen Feiertags, der in jedem Jahr am selben Datum zelebriert wird.</TD>
 * </TR>
 * </TABLE>
 * <BR>
 * &nbsp;
 ...
 *         <P>
 *
 * @changed OLI 19.05.2009 - &Uuml;berarbeitung der Dokumentation.
 *          <P>
 *
 * @deprecated OLI 19.05.2009 - Bitte Nutzen Sie die Klasse <TT>Holiday</TT> anstattdessen.
 *             <P>
 *
 * @see Holiday
 *      <P>
...
public class Feiertag {
	 ...
	 * @return null, wenn es sich nicht um einen Feiertag handelt, die Bezeichnung des Feiertages sonst.
	 */
	...
	public Ostersonntag(String ostersonntag, String bezeichnung) {
		...
		try {
			...
			throw new IllegalArgumentException(
					"date-string " + ostersonntag + " cannot be " + "converted to corent.dates.PDate!",
					dfe);
		}
