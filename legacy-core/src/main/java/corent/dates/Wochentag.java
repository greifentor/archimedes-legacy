...
/**
 * Mit Hilfe dieser Implementierung eines typsicheren Enum mit Ordinalzahlen werden die Wochentage repr&auml;sentiert.
 * <P>
 * Die Ordinalzahlen f&uuml;r die Wochentage sind nach dem in Deutschland g&uuml;ltigen System nummeriert. Die Woche
 * beginnt mit dem Montag (Ordinalzahl 0). Hieraus ergeben sich die folgenden Ordinalzahlen f&uuml;r die Wochentage
 * (Wochentag (Ordinalzahl)):<BR>
 * <BR>
 * Montag (0)<BR>
 * Dienstag (1)<BR>
 * Mittwoch (2)<BR>
 ...
 * Sonntag (6)<BR>
 * 
 * Der Vergleich der Wochentage &uuml;ber die <TT>compareTo</TT>-Methode richtet sich nach den Ordinalzahlen. Im
 ...
 *
 * <P>
 * Die <TT>toString()</TT>-Methode liefert den Namen des Wochentages. Die Methode <TT>ord()</TT> gibt die Ordinalzahl
 * des Wochentages zur&uuml;ck. Folgender Programmcode f&uuml;hrt zu nachfolgend angegebener Ausgabe:<BR>
 * 
 * <PRE>
 ...
 *
 * <P>
 * &Uuml;ber die statische Methode <TT>valueOf(int)</TT> kann der einer Ordinalzahl zugeordnete Wochentag ermittelt
 * werden:<BR>
 * 
 * <PRE>
 ...
 * 
 * <P>
 * <I>Hinweis:</I> Die Klasse gibt eine Testausgabe, wenn man ihre <TT>main</TT>-Methode aufruft.
 *
 * @author O.Lieshoff
 *
 * @changed OLI 24.08.2007 - Erweiterung der Dokumentation und Einbau einer <TT>main</TT>-Methode in der einige
 *          Testausgaben produziert werden.
 *
 */
...
public final class Wochentag implements Comparable {
	...
	/**
	 * Liefert den Namen des Wochentages (MONTAG.toString() liefert beispielsweise den String "Montag").
	 *
