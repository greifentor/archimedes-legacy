...
public class CompositeKeyDBOClassCodeGeneratorTest {

	private static final String BASE_PACKAGE_NAME = "base.pack.age.name";

	@InjectMocks
	private CompositeKeyDBOClassCodeGenerator unitUnderTest;
	...
	class TestsOfMethod_generate_String_TableModel {
		...
		class SimpleKey_RegularRun {
			...
			private String getExpected(String prefix, String packageName, boolean suppressComment,
				...
				if (!suppressComment) {
					s += "/**\n" + //
							" * A DBO composite key class for a_tables.\n" + //
							" *\n" + //
				...
				s += "@Accessors(chain = true)\n" + //
						...
						"@Generated\n" + //
						"@NoArgsConstructor\n" + //
						"public class ATableIdDBO implements Serializable {\n" + //
						"\n" + //
						"	private long id;\n" + //
