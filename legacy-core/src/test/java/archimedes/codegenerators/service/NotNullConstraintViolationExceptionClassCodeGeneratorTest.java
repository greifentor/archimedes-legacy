...
class NotNullConstraintViolationExceptionClassCodeGeneratorTest {
	...
	@InjectMocks
	private NotNullConstraintViolationExceptionClassCodeGenerator unitUnderTest;
	...
	@Nested
	class TestsOfMethod_isDeprecated {

		@Test
		void returnsTrue() {
			assertTrue(unitUnderTest.isDeprecated());
		}
