...
public class AbstractMasterDataBaseLayoutClassCodeGeneratorTest {
	...
	class TestsOfMethod_generate_String_TableModel {
		...
		void happyRunForASimpleObject() {
			// Prepare
			String expected = getExpected(null, "gui.vaadin.component", false, "null", 23);
		...
		void happyRunForASimpleObjectWithSuppressedComments() {
			// Prepare
			String expected = getExpected(null, "gui.vaadin.component", true, "null", 23);
			DataModel dataModel = readDataModel("Model.xml");
		...
		@Test
		void happyRunForASimpleObjectWithVaadinVersion24() {
			// Prepare
			String expected = getExpected(null, "gui.vaadin.component", false, "null", 24);
			DataModel dataModel = readDataModel("Model.xml");
			dataModel.getTableByName("A_TABLE");
