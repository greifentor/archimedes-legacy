...
public class VaadinTextAreaStylesCssFileGeneratorTest {

	private static final String BASE_PACKAGE_NAME = "base.pack.age.name";

	@InjectMocks
	private VaadinTextAreaStylesCssFileGenerator unitUnderTest;
	...
	class TestsOfMethod_generate_String_TableModel {
		...
		class Simple {
			...
			void worksWithCorrectFileName() {
				...
				// Run & Check
				assertEquals(
						"/frontend/styles/vaadin-text-area-styles.css",
