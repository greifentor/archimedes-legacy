...
public class VaadinComboBoxStylesCssFileGeneratorTest {

	private static final String BASE_PACKAGE_NAME = "base.pack.age.name";

	@InjectMocks
	private VaadinComboBoxStylesCssFileGenerator unitUnderTest;
	...
	class TestsOfMethod_generate_String_TableModel {
		...
		class Simple {
			...
			void worksWithCorrectFileName() {
				...
				// Run & Check
				assertEquals(
						"/frontend/styles/vaadin-combo-box-styles.css",
