	...
	class SimpleTable {
		...
		private String getExpected() {
			return "package base.pack.age.name.gui.vaadin.masterdata;\n" + //
					...
					"		setMargin(false);\n" + //
					"		setWidthFull();\n" + //
					"		ATableDetailsLayout fieldsLayout =\n" + //
					"				new ATableDetailsLayout(buttonFactory, model, service, resourceManager, session, this);\n"
					+ //
					"		add(\n" + //
					"				new HeaderLayout(\n" + //
					"						buttonFactory\n" + //
	...
	class ForeignKey {
		...
		private String getExpected() {
			return "package base.pack.age.name.gui.vaadin.masterdata;\n" + //
					...
					"		setWidthFull();\n" + //
					"		ATableDetailsLayout fieldsLayout =\n" + //
					"				new ATableDetailsLayout(buttonFactory, model, service, anotherTableService, resourceManager, session, this);\n"
					+ //
					"		add(\n" + //
					"				new HeaderLayout(\n" + //
					"						buttonFactory\n" + //
