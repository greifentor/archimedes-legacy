...
public class MaintenanceViewCreateNewModelModificationInterfaceCodeGeneratorTest {

	private static final String BASE_PACKAGE_NAME = "base.pack.age.name";

	@InjectMocks
	private MaintenanceViewCreateNewModelModificationInterfaceCodeGenerator unitUnderTest;
	...
	class TestsOfMethod_generate_String_TableModel {
		...
		private String getExpected(String prefix, String packageName, boolean suppressComment, String noKeyValue) {
			String s = "package " + BASE_PACKAGE_NAME
					+ "."
					+ (prefix != null ? prefix + "." : "")
					+ packageName
					+ ";\n" //
					+ "\n" //
					+ "public interface MaintenanceViewCreateNewModelModification<T> {\n" //
					+ "\n" //
					+ "	T modify(T model);\n" //
					+ "\n" //
					+ "}";
