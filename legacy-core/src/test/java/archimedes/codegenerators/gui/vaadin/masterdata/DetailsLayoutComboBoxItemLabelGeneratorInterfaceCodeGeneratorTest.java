...
public class DetailsLayoutComboBoxItemLabelGeneratorInterfaceCodeGeneratorTest {

	private static final String BASE_PACKAGE_NAME = "base.pack.age.name";

	@InjectMocks
	private DetailsLayoutComboBoxItemLabelGeneratorInterfaceCodeGenerator unitUnderTest;
