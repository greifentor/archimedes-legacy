...
public class ComponentFactoryClassCodeGeneratorTest {
	...
	class TestsOfMethod_generate_String_TableModel {
		...
		private String getExpectedDetailsReferencesOtherDetails() {
			return "package de.ollie.task.gui.vaadin.component;\n" //
					+ "\n" //
					+ "import java.time.LocalDateTime;\n" //
					+ "import java.util.Optional;\n" //
					+ "import java.util.function.Consumer;\n" //
					...
					+ "import de.ollie.task.core.model.TaskStatus;\n" //
					+ "import de.ollie.task.core.model.TodoPriority;\n" //
					+ "import de.ollie.task.core.model.TodoStatus;\n" //
					+ "import de.ollie.task.core.model.Note;\n" //
					+ "import de.ollie.task.core.model.Task;\n" //
					+ "import de.ollie.task.core.model.Todo;\n" //
					+ "import de.ollie.task.core.model.localization.LocalizationSO;\n" //
					+ "import de.ollie.task.core.service.localization.ResourceManager;\n" //
					+ "import de.ollie.task.gui.SessionData;\n" //
					+ "import de.ollie.task.gui.vaadin.ApplicationStartView;\n" //
					+ "import de.ollie.task.gui.vaadin.masterdata.MasterDataGridFieldRenderer;\n" //
					+ "\n" //
					+ "import lombok.Generated;\n" //
					+ "import lombok.Getter;\n" //
					+ "import lombok.RequiredArgsConstructor;\n" //
		...
		@Test
		void happyRun_ForDetailsReferencesOtherDetails() {
			// Prepare
			String expected = getExpectedDetailsReferencesOtherDetails();
