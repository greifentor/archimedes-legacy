...
SET CP=.\legacy-core\target\archimedes-legacy-core-%ARCHIMEDES_VERSION%-executable.jar
...
SET ADDITIONAL_OPTIONS=-Darchimedes.maximum.strlen.table.header=50 -Darchimedes.diagram.view.logic.enabled=true -Dconf_path=./legacy-core/src/main/resources/conf/ -DCodeFactory.templates.path=legacy-core/src/main/resources/templates
