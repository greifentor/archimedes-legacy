...
CP=./legacy-core/target/archimedes-legacy-core-1.94.3-executable.jar
...
ADDITIONAL_OPTIONS="-Darchimedes.maximum.strlen.table.header=50 -Dconf_path=./legacy-core/src/main/resources/conf/ -DRestControllerCodeFactory.templates.path=legacy-core/src/main/resources/templates/restcontroller"
