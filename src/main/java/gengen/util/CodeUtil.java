...
public class CodeUtil {
     ...
     * @param ownerName The name of the code owner (or <CODE>null</CODE> if the company name
     *         of the individual preferences should be used).
    ...
    public String createChangedTag(String comment) throws IllegalArgumentException {
        ...
        return "@changed " + Str.pumpUp(this.getUserToken(), " ", 3, Direction.RIGHT) + " "
                + this.date + " - " + comment;
    }
     ...
     * @param generatedWarning Set this flag to create a warning which marks the class as
     *         generated.
     ...
     * @changed OLI 24.07.2013 - Added.
     */
    public String createClassComment(String classComment, boolean generatedWarning)
            throws IllegalArgumentException {
     ...
     * @changed OLI 24.07.2013 - Added.
     */
    public String createClassHeaderComment(String className, boolean generatedWarning)
            throws IllegalArgumentException {
