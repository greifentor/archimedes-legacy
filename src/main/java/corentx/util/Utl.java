 ...
 * @changed OLI 05.02.2010 - Korrektur der <TT>null</TT>-Logik in den Methoden
...
public class Utl {
     ...
     * @return <TT>-1</TT>, wenn o0 gleich <TT>null</TT> und o1 ungleich <TT>null</TT>,
     *         <TT>0</TT>, wenn o0 gleich <TT>null</TT> und o1 gleich <TT>null</TT>,
     *         <TT>1</TT>, wenn o0 ungleich <TT>null</TT> und o1 gleich <TT>null</TT>,
     *         <TT>Integer.MAX_VALUE</TT>, wenn beide Objekte ungleich <TT>null</TT> sind.
     *
     * @changed OLI 05.02.2010 - Korrektur der <TT>null</TT>-Logik. Der <TT>null</TT>-Wert ist
     *         nun kleiner als ein belegter Wert.
     */
     ...
     * @return <TT>-1</TT>, wenn c0 gleich <TT>null</TT> und c1 ungleich <TT>null</TT>,
     *         <TT>0</TT>, wenn c0 gleich <TT>null</TT> und c1 gleich <TT>null</TT>,
     *         <TT>1</TT>, wenn c0 ungleich <TT>null</TT> und c1 gleich <TT>null</TT>,
    ...
    /**
     * Vergleicht die beiden angegebenen Objekte auf inhaltliche Gleichheit. Im Gegensatz zur
     * Methode <TT>equals(Object)</TT> aus der <TT>Object</TT>-Klasse, wird diese
     * Implementierung auch mit <TT>null</TT>-Referenzen fertig.
     *
     * @param o0 Das eine zu vergleichende Objekt.
     * @param o1 Das andere zu vergleichende Object.
     * @return <TT>true</TT>, falls beide Objekt inhaltlich gleich oder beide Objektreferenzen
     *         <TT>null</TT>-Referenzen sind; <BR><TT>false</TT> sonst.
     *
     ...
     * @throws NullPointerException Falls das Property-Set oder der Property-Name als
     ...
     * Java-String um. Hierbei kommt die Methode <TT>corentx.util.Str.FromHTML(String)</TT> 
     * zum Einsatz.
     * <BR>In dieser Variante wird kein Defaultwert angegeben. Anstelle dessen wird der Wert 
     * <TT>null</TT> angenommen.
     *
     * @param n Der Name der Property, die aus dem angegebenen Property-Set gelesen werden soll.
     * @return Der aus der HTML-Kodierung gewandelte Inhalt der Property.
     * @throws NullPointerException Falls der Property-Name als <TT>null</TT>-Referenz
    ...
    /**
     * Diese Methode ersetzt den angegebenen String durch den Inhalt der angegebenen Property
     * die, falls existent, gegen den Inhalt einer Property mit dem um den angegebenen Suffix
     * erweiterten Namen ersetzt wird.
     *
     * @param pn Der Name der Property.
     * @param def Ein Defaultwert, falls die Property "pn" nicht definiert ist.
     * @param suffix Der Suffix, der zus&auml;tzlich in der Form "pn" + "." + "suffix"
     *         untersucht werden soll. Existiert eine Property mit einem solchen Namen, so deren
     *         Wert zur&uuml;ckgegeben.
     * @throws NullPointerException Falls der Name der Property oder der Suffix als
     *         <TT>null</TT>-Referenz &uuml;bergeben werden.
     ...
     * @throws NullPointerException Falls der Dateiname als <TT>null</TT>-Referenz
     *         &uuml;bergeben wird.
     ...
     * @throws FileNotFoundException Falls es keine Datei unter dem angegebenen Namen gibt.
     * @throws IOException Falls es beim Einlesen der Datei zu einem Fehler kommt.
     * @throws NullPointerException Falls die Properties oder der Dateiname als
     *         <TT>null</TT>-Referenz &uuml;bergeben werden.
     *
