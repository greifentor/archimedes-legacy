 ...
 * repr&auml;sentiert.
 * <P>Die Funktionalit&auml;t der Methoden der Klasse wird stellenweise durch den in der Klasse
 * DBExec eingestellten Modus des bearbeiteten DBMS beeinflu&szlig;t. So liefert die Methode
 * <TT>GetSQLType(DBType, DBExecMode)</TT> z. B. im HSQL-Modus den Wert "longvarchar", anstatt 
 * der bei MSSQL und mySQL &uuml;blichen Bezeichnung "text".
 *
 * @author O.Lieshoff
 *
...
public final class DBType {
    ...
    /**
     * Liefert den Namen des SQLTyps zum DBType in Abh&auml;ngigkeit zum angegebenen DBExecMode
     * (LONGVARCHAR wird z. B. unter MSSQL als TEXT angegeben.
     *
     * @param dbmode Der DBExecMode, zu dem der entsprechende SQLTyp-Name f&uuml;r den
     *         vorliegenden DBType geliefert werden soll.
     ...
     * @return Der zur angegebenen Konstante passende DBType. Kann die Konstante nicht 
     *         zugeordnet werden, so wird der Wert INTEGER zur&uuml;ckgegeben.
     */
    ...
    /**
     * Liefert einen DBType zum angegebenen String bzw. <TT>null</TT>, wenn der String auf 
     * keinen DBType pa&szlig;t.
     *
     * @param s Der String, zu dem der passende DBType gesucht werden soll (der String mu&szlig;
     *         den Namen des DBTypes enthalten).
     * @return Der zu s passende DBType, oder <TT>null</TT>, wenn s keinen Namen eines DBTypes
     *         enth&auml;lt.
     */
