...
/** 
 * Diese Klasse enth&auml;lt die zu einer Tabellenspalte notwendigen Informationen und Methoden,
...
public class ColumnRecord implements Serializable {
    ...
    /*
     * Diese Flagge mu&szlig; gesetzt werden, wenn die Daten der Spalte kodiert gespeichert 
     * sind. 
     */
    ...
    /* 
     * Hier kann eine Klasse angegeben werden, in der Wert der Tabellenspalte beim Lesen 
     ...
     * @throws NullPointerException Falls einer der beiden Werte mit einem <TT>null</TT>-Wert
     *     belegt werden soll.
     */
     ...
     * @param tablename Der Name der Tabelle, zu der die Tabellenspalte geh&ouml;rt.
     * @param columnname Der eigentliche Spaltenname.
     * @param pkmember Diese Flagge mu&szlig; gesetzt werden, wenn der ColumnRecord ein Teil
     *     des Prim&auml;rschl&uuml;ssels der Tabelle ist.
     * @throws NullPointerException Falls einer der beiden Werte mit einem <TT>null</TT>-Wert
     *     belegt werden soll.
     */
     ...
     * @param pkmember Diese Flagge mu&szlig; gesetzt werden, wenn der ColumnRecord ein Teil
     *     des Prim&auml;rschl&uuml;ssels der Tabelle ist.
     * @param convertto Eine Klassenangabe, in die das Objekt beim Einlesen konvertiert werden 
     *     soll. 
     * @throws NullPointerException Falls einer der beiden Werte mit einem <TT>null</TT>-Wert
     *     belegt werden soll.
     */
     ...
     * @throws IllegalArgumentException Wenn versucht wird, der Eigenschaft einen Wert kleiner 0
     *     zu &uum;bergeben.
     */
     ...
     * @throws IllegalArgumentException Wenn versucht wird, der Eigenschaft einen leeren String
     *     zu &uum;bergeben.
     * @throws NullPointerException Wenn versucht wird, der Eigenschaft einen <TT>null</TT>-Wert
     *     zu &uum;bergeben.
     */
    public void setColumnname(String columnname) {
        ...
        if (columnname.length() < 1) {
            throw new IllegalArgumentException("ColumnRecord.Columnname is able to have a "
    ...
    public void setTablename(String tablename) {
        ...
        if (tablename.length() < 1) {
            throw new IllegalArgumentException("ColumnRecord.Tablename is able to have a "
                    + "minimum length of 1 character!");
        }
    ...
    public boolean equals(Object o) {
        ...
        return this.getTablename().equals(cr.getTablename()) && this.getColumnname().equals(
                cr.getColumnname());
    }
    
    public String toString() {
        return new StringBuffer(this.getTablename()).append(".").append(this.getColumnname()
                ).toString();
    }
