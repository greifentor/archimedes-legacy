...
/**
 * Diese Klasse bietet eine Handvoll Methoden an, die f&uuml;r die Arbeit mit
 * dem Dateisystem gedacht sind.
 *
 * @author O.Lieshoff
 *         <P>
 *
 * @changed OLI 23.07.2008 - Erweiterung um die TextFile-Methoden
 *          (WriteTextToFile(String, boolean, String) und
 *          ReadTextFromFile(String)) aus der Klasse corent.tools.Tools.
 *          <P>
 *          OLI 12.02.2009 - Erweiterung um die Methode
 *          <TT>CompletePath(String)</TT>.
 *          <P>
 *          OLI 13.02.2009 - Erweiterung um die Methode
 *          <TT>ReadStringList(String)</TT>.
 *          <P>
 *          OLI 02.04.2009 - Erweiterung um die Methode
 *          <TT>ReadTextFromFile(String, String)</TT>.
 *          <P>
 *          OLI 03.04.2009 - Debugging an der Methode
 *          <TT>ReadTextFromFile(String)</TT>.
 *          <P>
 *
 */
...
public class FileUtil {
	...
	/**
	 * Vervollst&auml;ndigt gegebenenfalls ein Pfadangabe mit einem abschliessenden
	 * Slash. Bei Dieser Gelegenheit werden alle Backslashes in dem String in
	 * Slashes umgesetzt.
	 *
	 * @param path Ein Pfad zur Vervollst&auml;ndigung.
	 * @return Ein mit einem Slash abschliessender Pfad, dessen Backslashes gegen
	 *         Slashes ersetzt worden sind.
	 *
	...
	/**
	 * Liefert eine Liste aller Dateinamen der Dateien, die in dem angegebenen Pfad
	 * (und seinen Untervezeichnissen) abgelegt.
	 *
	 ...
	 *
	 * @changed OLI 23.07.2008 - Hinzugef&uuml;gt.
	 *
	 */
	 ...
	 *         Namens gefunden wird. Sonst <TT>null</TT>.
	 *
	 * @changed OLI 23.07.2008 - Hinzugef&uuml;gt und Inhalt aus FindPath(File,
	 *          String, boolean) &uuml;bernommen.
	 *          <P>
	 *          OLI 24.07.2008 - Ersatz durch PathFinder-Aufruf.
	 *
	 */
	public static String FindPath(File f, String fn, boolean echo, boolean gcs, corent.files.PathFinderListener pfl) {
		corent.files.PathFinder pf = new corent.files.PathFinder();
		return pf.find(f, fn, echo, gcs, pfl);
	}

	/**
	 * Die Implementierung der Main-Methode dient dem Text einiger Methoden der
	 * Klasse.
	 *
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < roots.length; i++) {
			log.info(FindPath(roots[i], args[0], true));
		}
		System.exit(0);
	}
	 ...
	 * Listenelement. Zeilen, die mit der Raute (#) beginnen, werden als Kommentar
	 * gewertet und ignoriert. Leere Zeilen werden ebenfalls ignoriert.
	 *
	 * @param filename Der Name der Datei, aus der der Text gelesen werden soll.
	 * @param trim     Wenn diese Flagge gesetzt wird, wird die eingelesene Zeile
	 *                 vor allen anderen Aktionen getrimmt (d. h. f&uuml;hrende und
	 *                 abschliessende Leerzeichen werden entfernt.
	 * @return Eine Liste mit den aus der Datei gelesenen Strings.
	 * @throws FileNotFoundException Weiterreichen der durch den Lesezugriff
	 *                               entstehenden Exceptions.
	 * @throws IOException           Weiterreichen der durch den Lesezugriff
	 *                               entstehenden Exceptions.
	 *
	 ...
	 *
	 */
	public static List<String> ReadStringList(String filename, boolean trim) throws FileNotFoundException, IOException {
	...
	/**
	 * Liest einen Text (mit Zeilenumbr&uuml;chen) aus der angegebenen Datei. Es
	 * kann eine Kommentarsequenz vereinbart werden, mit deren Hilfe Zeilen aus dem
	 * Lesevorgang ausgeklammert werden k&ouml;nnen. Die Kommentarsequenz mu&szlig;
	 * am Anfang der Zeile stehen.
	 *
	 * @param filename        Der Name der Datei, aus der der Text gelesen werden
	 *                        soll.
	 * @param commentSequence Eine Sequenz, die den Anfang von zu ignorierenden
	 *                        Kommentarzeilen kennzeichnet. Wird hier der Wert
	 *                        <TT>null</TT> &uuml;bergeben, so wird keine Zeile
	 *                        auskommentiert.
	 * @return Der Text, der aus der Datei gelesen worden ist.
	 * @throws FileNotFoundException Weiterreichen der durch den Lesezugriff
	 *                               entstehenden Exceptions.
	...
	/**
	 * Liefert die letzten n (=lines) Zeilen der durch den Namen angegebenen
	 * Textdatei.
	 *
	 ...
	 * @throws IOException           Weiterreichen der durch den Schreibzugriff
	 *                               entstehenden Exceptions.
	 *
	 ...
	 *
	 */
	public static List<String> Tail(String fn, int lines) throws FileNotFoundException, IOException {
	...
	/**
	 * Schreibt den &uuml;bergebenen Text als Textdatei mit dem angegebenen
	 * filename.
	 *
	 * @param filename Der Name der Datei, in die der angegebene Text geschrieben
	 *                 werden soll.
	 * @param append   Die Append-Flagge zum &Ouml;ffnen der Datei.
	 * @param text     Der Text, der in die angegebene Datei geschrieben werden
	 *                 soll.
	 * @throws IOException Weiterreichen der durch den Schreibzugriff entstehenden
	 *                     Exceptions.
	 *
	 * @changed OLI 23.07.2008 - Aus corent.tools.Tools hergezogen.
	 *          <P>
