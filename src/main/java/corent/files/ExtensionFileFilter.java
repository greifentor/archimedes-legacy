...
/**
 * Diese Klasse konkretisiert einen FileFilter in der Form, da&szlig; er nur Files mit bestimmten Extensions akzeptiert.
 *
 * @author O.Lieshoff
 *
 * @changed OLI 05.09.2007 - &Auml;nderung wegen <I>deprecation</I> der Klasse <TT>
...
public class ExtensionFileFilter extends FileFilter implements FilenameFilter {
	...
	/**
	 * Generiert einen FileFilter auf Basis der in dem &uuml;bergebenen Array vorgefundenen Extensions.
	 *
	...
	private ExtensionFileFilter(String[] extensions, String description) {
		super();
	...
	/**
	 * @changed OLI 05.09.2007 - &Auml;nderung des Aufrufs der Methode <TT>GetExtension(File)</TT> auf die Methode der
	 *          Klasse <TT>corent.util.FileUtil</TT>. Die Klasse dieses Packages (corent.files.FileUtil) wurde auf
	 *          deprecated gesetzt.<BR>
	 */
	public boolean accept(File f) {
		if (f.isDirectory()) {
			return true;
		}
		String extension = corentx.io.FileUtil.getExtension(f);
		if (extension != null) {
