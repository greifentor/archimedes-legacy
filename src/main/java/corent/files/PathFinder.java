...
/**
 * Diese Klasse erm&ouml;glicht das Auffinden einer Datei in einem Verzeichnisbaum.
 *
 * <P><I>Hinweis:</I> Die Klasse kann bei gro&szlig;en Dateib&auml;umen kurzfristig einen hohen
 ...
 *
 * @changed
 *     OLI 24.08.2008 - Hinzugef&uuml;gt.
 *     <P>
 *
 */
...
public class PathFinder {
     ...
     *
     * @changed
     *     OLI 24.07.2008 - Hinzugef&uuml;gt und Inhalt aus corent.util.FindPath(File, String, 
     *             boolean) &uuml;bernommen.
     *     <P>
     *
     */
    public synchronized String find(File f, String fn, boolean echo, boolean gcs, 
            PathFinderListener pfl) {
        if (echo) {
