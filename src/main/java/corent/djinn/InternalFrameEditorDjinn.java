 ...
 *
 * @changed
 *     OLI 29.10.2007 - Erweiterung der Methode <TT>transferValues()</TT> um den Parameter
 *             <TT>saveOnly</TT>. Anpassungen an das DefaultEditorDjinnPanel mit 
 *             Speichern-Button.
 *     <P>OLI 18.01.2008 - Erweiterung um die Implementierung des Interfaces Ressourced.
 *     <P>OLI 26.02.2008 - Umstellung auf EditorDjinnMode-Betrieb.
 ...
 *     <P>OLI 19.06.2008 - Erweiterung um die Methode <TT>doOpened()</TT> und die damit 
 *             verbundene Logik.
...
public class InternalFrameEditorDjinn extends JInternalFrameWithInifile 
        implements EditorDjinnController, Ressourced {
    
    /* Diese Flagge wird gesetzt, wenn der EditorDjinn zur Stapelpflege ge&ouml;ffnet ist. */
     ...
     */ 
    public InternalFrameEditorDjinn(JDesktopPane desktop, String titel, Editable e, 
            boolean loeschenAktiviert) {
        this(desktop, titel, e, loeschenAktiviert, false, null, false, false,
     ...
     */ 
    public InternalFrameEditorDjinn(JDesktopPane desktop, String titel, Editable e, 
            boolean loeschenAktiviert, Inifile ini) {
        this(desktop, titel, e, loeschenAktiviert, false, ini, false, false,
                EditorDjinnMode.EDIT);
    }
     ...
     */ 
    public InternalFrameEditorDjinn(JDesktopPane desktop, String titel, Editable e, 
            boolean loeschenAktiviert, boolean druckenAktiviert, Inifile ini) {
        this(desktop, titel, e, loeschenAktiviert, druckenAktiviert, ini, false, false,
                EditorDjinnMode.EDIT);
    }
     ...
     */ 
    public InternalFrameEditorDjinn(JDesktopPane desktop, String titel, Editable e, 
            boolean loeschenAktiviert, boolean druckenAktiviert, Inifile ini, boolean split,
            boolean locked) {
        this(desktop, titel, e, loeschenAktiviert, druckenAktiviert, ini, split, locked, 
                EditorDjinnMode.EDIT);
    }
     ...
     *     eingef&uuml;gt.
     * @param locked Diese Flagge mu&szlig; gesetzt werden, wenn der Datensatz gesperrt ist.
     * @param mode Der Modus, in dem das Panel betrieben werden soll (Neuanlage, &Auml;nderung
     *     oder Duplikation).
     */ 
    public InternalFrameEditorDjinn(JDesktopPane desktop, String titel, Editable e, 
            boolean loeschenAktiviert, boolean druckenAktiviert, Inifile ini, boolean split,
            boolean locked, EditorDjinnMode mode) {
        this(desktop, titel, e, loeschenAktiviert, druckenAktiviert, false, ini, split, locked, 
                mode, false);
    }
     ...
     * @param mode Der Modus, in dem das Panel betrieben werden soll (Neuanlage, &Auml;nderung
     *     oder Duplikation).
     * @param batch Diese Flagge mu&szlig; gesetzt werden, wenn der EditorDjinn als Stapelpflege
     *     ge&ouml;ffnet werden soll.
     */ 
    public InternalFrameEditorDjinn(JDesktopPane desktop, String titel, Editable e, 
            boolean loeschenAktiviert, boolean druckenAktiviert, boolean historieAktiviert, 
            Inifile ini, boolean split, boolean locked, EditorDjinnMode mode, boolean batch) {
        super(titel, ini);
        this.batch = batch;
        ...
        if (Boolean.getBoolean("corent.debug") || Boolean.getBoolean("corent.djinn.debug")) {
            System.out.println("InternalFrameEditorDjinn opened with context " 
                    + this.getContext());
        }
        this.panel = new DefaultEditorDjinnPanel(this, e, new DefaultEditorDjinnButtonFactory(
                loeschenAktiviert, e instanceof JasperReportable, historieAktiviert), split, 
                locked, ini, mode, batch) {
    ...
    /**
     * Diese Methode wird aufgerufen, nachdem der Djinn beschworen und angezeigt ist.
     *
     * @changed
     *     OLI 19.06.2008 - Hinzugef&uuml;gt.
     *     <P>
     *
     */
    ...
    /** 
     * Liefert den Wert <TT>true</TT>, wenn der EditorDjinn als Stapel&auml;nderung l&auml;uft.
     *
     * @return <TT>true</TT>, wenn der EditorDjinn als Stapel&auml;nderung aufgerufen worden 
     *     ist.
     */
    ...
    /** 
     * Diese Methode mu&szlig; den Wert <TT>true</TT> zur&uuml;ckliefern, wenn der Datensatz
     * einzigartig ist.
     *
    ...
    /** 
     * Ein Aufruf dieser Methode &uuml;bertr&auml;gt den Inhalt des EditorPanels in das Objekt.
     * Beim Aufruf dieser Methode ist &auml;u&szlig;erste Vorsicht geboten, da Nebeneffekte in
     * der Bearbeitungslogik des EditorDjinns nicht ausgeschlossen werden k&ouml;nnen.
     *
     * @param saveOnly Diese Flagge mu&szlig; gesetzt werden, wenn der Djinn seine Daten 
     *     speichern soll, ohne geschlossen zu werden.
     * @return <TT>true</TT>, wenn der Transfer erfolgreich abgeschossen werden konnte, 
     *     <TT>false</TT> sonst.
     *
     * @changed
     *     OLI 29.10.2007 - Erweiterung um den Parameter <TT>saveOnly</TT>.<BR>
