...
/**
 * Eine Musterimplementierung f&uuml;r eine auf einer JList basierenden ViewComponent.<BR>
 * <HR>
 *
 * @author O.Lieshoff
 *
...
public class DefaultListViewComponent implements ViewComponent {
    ...
    /* Referenz auf die vollst&auml;ndige Liste, aus der der View einen Ausschnitt zeigt. */
    private Vector liste = null;
    
    /**
     * Generiert eine DefaultListViewComponent anhand der &uuml;bergebenen Parameter.
     *
     * @param liste Die Liste, deren Inhalt in der ViewComponent angezeigt werden soll.
     */
    ...
    public int updateView(Object[] criteria, String additions) throws IllegalArgumentException {
        ...
        if (this.liste != null) {
            for (int i = 0, len = this.liste.size(); i < len; i++) {
                System.out.println(this.liste.elementAt(i));
