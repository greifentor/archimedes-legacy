...
/**
 * Dieser Dialog geht auf eine &auml;ltere Version zur&uuml;ck, die bereits die gleiche 
 * Funktionalit&auml;t allerdings auf die PDate-Klasse gem&uuml;nzt ist, die aus dem jim-Projekt
 * ihren Weg in die CoreLib gefunden hat.
 *
 * <P>Der Dialog kann &uuml;ber den Aufruf der main-Methode der Klasse getestet werden.
 *
 * <HR SIZE=3>
 * <H3>Properties</H3>
 * <HR>
 ...
 *         <TD></TD>
 *         <TD>String</TD>
 *         <TD>Name der Grafikdatei in der das Icon des Abbruchbuttons hinterlegt ist.</TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 ...
 *         <TD>String</TD>
 *         <TD>
 *             Name der Grafikdatei in der das Icon des L&ouml;schenbuttons hinterlegt ist.
 *         </TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 ...
 *         <TD></TD>
 *         <TD>String</TD>
 *         <TD>Der Inhalt des Tooltiptextes zum L&ouml;schenbutton des DateDialoges.</TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 ...
 *         <TD>String</TD>
 *         <TD>
 *             Name der Grafikdatei in der das Icon des Verringernbuttons zu Jahreseingabe 
 *             hinterlegt ist.
 *         </TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 ...
 *         <TD>String</TD>
 *         <TD>
 *             Name der Grafikdatei in der das Icon des Erh&ouml;henbuttons zu Jahreseingabe 
 *             hinterlegt ist.
 *         </TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 ...
 *         <TD>String</TD>
 *         <TD>
 *             Die Tagesbezeichnungen zum Tag n. Die Z&auml;hlung der Tage beginnt mit ?.
 *         </TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 ...
 *         <TD>Monat:</TD>
 *         <TD>String</TD>
 *         <TD>Die Beschriftung des Labels vor der Monatsauswahlbox des DateDialoges.</TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 *         <TD>corent.gui.DateDialog.label.year</TD>
 *         <TD>Jahr:</TD>
 *         <TD>String</TD>
 *         <TD>Die Beschriftung des Labels vor dem Jahreseingabefeld des DateDialoges.</TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 ...
 *         <TD>String</TD>
 *         <TD>
 *             Die Monatsbezeichnungen zum Monat n. Die Z&auml;hlung der Monate beginnt mit 1.
 *         </TD>
 *     </TR>
 *     <TR VALIGN=TOP>
 ...
 *         <TD>Boolean</TD>
 *         <TD>
 *             Wenn diese Property gesetzt wird, wird das Eingabefeld f&uuml;r die Jahreszahlen
 *             abgeblendet. Die Jahreszahl kann dann nur noch mit den nebenstehenden Buttons
 *             manipuliert werden.
 *         </TD>
 *     </TR>
 * </TABLE>
 ...
 * @author O.Lieshoff
 *
 * @changed OLI 23.11.2007 - Einbau einer M&ouml;glichkeit, Labels etc. &uuml;ber Ressourcen zu
 *         definieren.
 * @changed OLI 02.04.2008 - Debugging des Jahresfeldproblems und Einbau einer Testfunktion
 *         &uuml;ber die <TT>main(String[])</TT>-Methode. Erstmal konnte das Problem nur durch
 *         Abblendung des Textfeldes beseitigt werden.
 * @changed OLI 19.12.2008 - Methoden <TT>addPDateDialogListener(DateListener)</TT> und
 *         <TT>removePDateDialogListener(DateListener)</TT> auf <TT>deprecated</TT> gesetzt.
 * @changed OLI 19.05.2010 - Einf&auml;rben von Feiertagen in gelber Farbe. Setzen eines
 *         Tooltiptextes mit der Bedeutung des Feiertages. Dabei: Formatanpassungen.
 */
...
public class DateDialog extends JDialog implements ActionListener, ItemListener, Releaseable {
    ...
    private JButton buttonAbbruch = new JButton(Utl.GetProperty(
            "corent.gui.DateDialog.button.cancel.text", "Abbruch"));
    /* Der Clear-Button <I>(Default new JButton("C"))</I>. */
    private JButton buttonClear = new JButton(Utl.GetProperty(
            "corent.gui.DateDialog.button.clear.text", "C"));
    ...
    private JButton buttonOk = new JButton(Utl.GetProperty(
            "corent.gui.DateDialog.button.ok.text", "Ok"));
    private JButton[] buttonTag = new JButton[31];
    private JLabel labelDatum = new JLabel("", SwingConstants.CENTER);
    private JLabel labelJahr = new JLabel(Utl.GetProperty("corent.gui.DateDialog.label.year", 
            "Jahr:") + " ", SwingConstants.RIGHT);
    private JLabel labelMonat = new JLabel(Utl.GetProperty("corent.gui.DateDialog.label.month", 
            "Monat:") + " ", SwingConstants.RIGHT);
    ...
    /**
     * Diese Methode montiert das Hauptpanel des Fensters zusammen und f&uuml;gt es als 
     * ContentPane in das Fenster ein.
     *
     * @param d Ein PDate als Voreinstellung f&uuml;r den Dialog.
     */
    public void construct(PDate d) {
        ...
        this.panelSouth.add(new JLabel(""));
        pane.setBorder(new CompoundBorder(new EtchedBorder(EtchedBorder.RAISED),
                new EmptyBorder(5, 5, 5, 5)));
        this.panelNorth.setBorder(new CompoundBorder(new EtchedBorder(EtchedBorder.RAISED),
                new EmptyBorder(5, 5, 5, 5)));
        this.panelCenter.setBorder(new CompoundBorder(new EtchedBorder(EtchedBorder.RAISED),
                new EmptyBorder(5, 5, 5, 5)));
        this.panelSouth.setBorder(new CompoundBorder(new EtchedBorder(EtchedBorder.RAISED),
                new EmptyBorder(5, 5, 5, 5)));
        ...
        panelButtons.setBorder(new CompoundBorder(new EtchedBorder(EtchedBorder.RAISED),
                new EmptyBorder(5, 5, 5, 5)));
    ...
    private void updateDatum() {
        ...
        */
        ...
        this.labelDatum.setText(this.eingabedatum.toString() + " - " + Utl.GetProperty(
                "corent.gui.DateDialog.day." + i, this.eingabedatum.getTagesnameDeutsch()));
    }
    ...
    private void update(boolean inclCombo) {
        if (this.panelCenter != null) {
            ...
            PDate dummy = d;
            for (int i = 1; i <= 7; i++) {
                pane.add(new JLabel(Utl.GetProperty("corent.gui.DateDialog.day." + i, 
                        d.getTagesnameDeutsch()).substring(0, Integer.getInteger(
                        "corent.gui.DateDialog.day.token.length", 2)), SwingConstants.CENTER));
                d = d.naechsterTag();
            }
            d = dummy;
            for (int i = 0; i < 42; i++) {
                if ((d.getWochentag() == Wochentag.MONTAG) && (d.toInt()
                        <= (new PDate(1, monat, jahr)).monatsLetzter().toInt())) {
            ...
            panelButtons.add(buttonAbbruch);
            JPanel panel = new JPanel(new BorderLayout(5, 5));
            panel.setBorder(new EmptyBorder(5, 5, 5, 5));
            panel.add(pane, BorderLayout.CENTER);
            panel.add(panelButtons, BorderLayout.SOUTH);
            ...
            */
            if (!packed) {
                ...
                this.setBounds(((int) dtd.getWidth() / 2) - (this.getWidth() / 2),
                        ((int) dtd.getHeight() / 2) - (this.getHeight() / 2), this.getWidth(),
                        this.getHeight());
            }
        }
    }
     ...
     *
     * @param p Das PDate, das an den DateDialog &uuml;bergeben und angezeigt werden soll.
     */
    ...
    /**
     * Liefert eine Referenz auf das PDate-Objekt, das in dem DateDialog angezeigt werden soll.
     *
    ...
    /**
     * F&uuml;gt den angegebenen DateListener an die Liste der an dem DateDialog horchenden 
     * Listener an.
     *
     * @param l Der DateListener, der an die Liste der an dem DateDialog horchenden DateListener
     *         angef&uuml;gt werden soll.
     *
     * @deprecated
     *     OLI 19.12.2008 - Da der Dialog (gewollt) modal ist, kann der Listener nicht 
     *             rechtzeitig eingeh&auml;ngt werden, weil der Methodenaufruf erst nach dem 
     *             Beenden des Dialoges von au&szlig;en erfolgen kann. Das ist also Nonsens ...
     *     <P>
     */
    ...
    /**
     * L&ouml;scht den angegebenen DateListener aus der Liste der an dem DateDialog horchenden 
     * Listener.
     *
     ...
     *
     * @deprecated
     *     OLI 19.12.2008 - Die Herausnahme der Methode begr&uuml;ndet sich aus dem geplanten
     *             Wegfall der Methode <TT>addPDateDialogListener(DateListener)</TT>.
     *     <P>
     */
    ...
    /** Diese Methode wird ausgef&uuml;hrt, wenn der Benutzer der Clear-Button dr&uuml;ckt. */
    ...
    public static void main(String[] args) {
        PDate pd = new PDate();
        DateDialog dd = new DateDialog("Testdialog", pd);
        dd.addPDateDialogListener(new DateListener() {
            public void dateChanged(PDate pd) {
                System.out.println("\nDateListener.dateChanged(" + pd + ")");
            }
        });
        System.out.println("\nDateDialog.getDate() = " + dd.getDate());
        System.exit(0);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == this.buttonJahrInc) {
            int lastday =(new PDate(1, this.comboBoxMonat.getSelectedIndex()+1,
                    this.eingabedatum.getJahr()+1)).monatsLetzter().getTag();
            ...
            this.eingabedatum = this.eingabedatum.setMonat(this.comboBoxMonat.getSelectedIndex()
                    +1);
            this.update();
            return;
    ...
    public void itemStateChanged(ItemEvent e) {
        if (e.getSource() == this.comboBoxMonat) {
            int lastday = (new PDate(1, this.comboBoxMonat.getSelectedIndex()+1,
                    this.eingabedatum.getJahr())).monatsLetzter().getTag();
            if (lastday < this.eingabedatum.getTag()) {
                this.eingabedatum = this.eingabedatum.setTag(lastday);
            }
            this.eingabedatum = this.eingabedatum.setMonat(this.comboBoxMonat.getSelectedIndex()
