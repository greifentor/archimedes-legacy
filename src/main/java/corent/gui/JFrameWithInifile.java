...
/**
 * Diese Klasse erweitert die Funktionalit&auml;t eines JFrames um die F&auml;higkeit, seine
 * Daten in eine Ini-Datei abzuspeichern.
 *
 * @author O.Lieshoff
 *
 */
...
public class JFrameWithInifile extends JFrame implements ComponentWithInifile, ContextOwner {
     ...
     * Angaben der Ini-Datei restauriert <I>(Constants.BRUTERESTORE) </I>.
     */
    ...
    /**
     * Generiert einen einfachen, titellosen Frame mit der &uuml;bergebenen IniDatei.
     *
    ...
    public void setVisible(boolean b) {
        if (b) {
            ...
            if (this.ini != null) {
                ...
                try {
/*
System.out.println("\n\nsetVisible(" + b + ") -> x=" + r.x + ", y=" + r.y + ", w=" + r.width 
        + ", h=" + r.height);
*/                    
