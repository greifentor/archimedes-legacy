...
public class DiagramParameterXMLBuilder extends AbstractXMLBuilder {
    ...
    public XMLNode buildNodes(DataModel diagram, XMLNodeFactory xmlNodeFactory) {
        ...
        this.addAttribute(parameters, "additionalSQLScriptListener",
                diagram.getAdditionalSQLScriptListener());
        this.addAttribute(parameters, "applicationName", diagram.getApplicationName());
        this.addAttribute(parameters, "deprecatedTablesHidden",
                String.valueOf(diagram.isDeprecatedTablesHidden()));
        ...
        this.addAttribute(parameters, "dbVersionColumnDescriptionName",
                diagram.getDBVersionDescriptionColumnName());
        this.addAttribute(parameters, "dbVersionColumnVersionName",
                diagram.getDBVersionVersionColumnName());
        this.addAttribute(parameters, "dbVersionTableName", diagram.getDBVersionTableName());
        this.addAttribute(parameters, "disableTechnicalFields",
                String.valueOf(diagram.isPaintTechnicalFieldsInGray()));
        this.addAttribute(parameters, "disableTransientFields",
                String.valueOf(diagram.isPaintTransientFieldsInGray()));
        this.addAttribute(parameters, "fontSizeDiagramHeadlines",
                String.valueOf(diagram.getFontSizeDiagramHeadline()));
        this.addAttribute(parameters, "fontSizeDiagramSubtitles",
                String.valueOf(diagram.getFontSizeSubtitles()));
        this.addAttribute(parameters, "fontSizeTableContents",
                String.valueOf(diagram.getFontSizeTableContents()));
        this.addAttribute(parameters, "history", diagram.getHistory());
        this.addAttribute(parameters, "markUpRequiredFieldNames",
                String.valueOf(diagram.isMarkUpRequiredFieldNames()));
        ...
        this.addAttribute(parameters, "relationColorRegular",
                String.valueOf(diagram.getRelationColorRegular()));
        ...
        this.addAttribute(parameters, "showReferencedColumns",
                String.valueOf(diagram.isShowReferencedColumns()));
