...
import archimedes.legacy.model.gui.*;
import corentx.xml.*;
...
public class TableXMLBuilder extends AbstractXMLBuilder {
    ...
    public XMLNode buildNodes(TableModel[] tables, XMLNodeFactory xmlNodeFactory) {
        ...
        for (TableModel t : tables) {
            ...
            this.addAttribute(tableNode, "activeInApplication", String.valueOf(
                    t.isActiveInApplication()));
            this.addAttribute(tableNode, "additionalCreateConstraint",
                    t.getAdditionalCreateConstraints());
            ...
            this.addAttribute(tableNode, "firstGenerationDone", String.valueOf(
                    t.isFirstGenerationDone()));
            ...
            for (ColumnModel c : t.getColumns()) {
                ...
                this.addAttribute(node, "editorAlterInBatchView", String.valueOf(
                        c.isEditorAlterInBatchView()));
                ...
                this.addAttribute(node, "editorReferenceWeight", String.valueOf(
                        c.getEditorReferenceWeight().name()));
                ...
                this.addAttribute(node, "indexSearchMember", String.valueOf(
                        c.isIndexSearchMember()));
                this.addAttribute(node, "individualDefaultValue", c.getIndividualDefaultValue()
                        );
                this.addAttribute(node, "lastModificationField", String.valueOf(
                        c.isLastModificationField()));
                ...
                this.addAttribute(node, "panelNumber", String.valueOf(t.getPanelPosition(
                        c.getPanel())));
                ...
                if (c.getRelation() != null) {
                    ...
                    this.addAttribute(relation, "referenceColumnName", r.getReferenced(
                            ).getName());
                    this.addAttribute(relation, "referenceTableName", r.getReferenced(
                            ).getTable().getName());
                    for (GUIViewModel gv : ((GUIRelationModel) r).getViews()) {
                        ...
                        this.addAttribute(view, "direction0", String.valueOf(
                                ((GUIRelationModel) r).getDirection((GUIViewModel) v, 0
                                ).toString()));
                        this.addAttribute(view, "direction1", String.valueOf(
                                ((GUIRelationModel) r).getDirection((GUIViewModel) v, 1
                                ).toString()));
                        this.addAttribute(view, "name", v.getName());
                        this.addAttribute(view, "offset0", String.valueOf(((GUIRelationModel) r
                                ).getOffset((GUIViewModel) v, 0)));
                        this.addAttribute(view, "offset1", String.valueOf(((GUIRelationModel) r
                                ).getOffset((GUIViewModel) v, 1)));
                        List<Point> pts = ((GUIRelationModel) r).getPointsForView(
                                (GUIViewModel) v);
                        for (Point p : pts) {
                ...
                this.addAttribute(node, "removedStateField", String.valueOf(
                        c.isRemovedStateField()));
                this.addAttribute(node, "required", String.valueOf(c.isRequired()));
                this.addAttribute(node, "sequenceForKeyGeneration",
                        (c.getSequenceForKeyGeneration() != null
                        ? c.getSequenceForKeyGeneration().getName() : ""));
                this.addAttribute(node, "suppressForeignKeyConstraints", String.valueOf(
                        c.isSuppressForeignKeyConstraint()));
            ...
            for (ColumnModel c : t.getCompareMembers()) {
                XMLNode compareToNode = xmlNodeFactory.createXMLNode(tableNode,
                        "CompareToMember");
            ...
            for (NReferenceModel nr : t.getNReferences()) {
                ...
                this.addAttribute(compareToNode, "deleteConfirmationRequired",
                ...
                this.addAttribute(compareToNode, "nReferencePanelType", String.valueOf(
                        nr.getNReferencePanelType().name()));
                this.addAttribute(compareToNode, "panelNumber", String.valueOf(nr.getPanel(
                        ).getPanelNumber()));
                this.addAttribute(compareToNode, "permitCreate", String.valueOf(
                        nr.isPermitCreate()));
            ...
            for (OptionModel o : t.getOptions()) {
                XMLNode node = xmlNodeFactory.createXMLNode(tableNode, "Option");
                this.addAttribute(node, "name", o.getName());
                this.addAttribute(node, "parameter", o.getParameter());
            }
            */
            ...
            for (SelectionMemberModel smm : t.getSelectableColumns()) {
                XMLNode selectionMemberNode = xmlNodeFactory.createXMLNode(tableNode,
                        "SelectionMember");
                this.addAttribute(selectionMemberNode, "printExpression", String.valueOf(
                        smm.getPrintExpression()));
                this.addAttribute(selectionMemberNode, "selectionAttributeName", String.valueOf(
                        smm.getAttribute()));
                this.addAttribute(selectionMemberNode, "columnName", smm.getColumn().getName());
                this.addAttribute(selectionMemberNode, "tableName", smm.getColumn().getTable(
                        ).getName());
            }
            for (OrderMemberModel om : t.getSelectionViewOrderMembers()) {
                ...
                this.addAttribute(node, "direction", String.valueOf(om.getOrderDirection(
                        ).name()));
            ...
            for (ViewModel v : t.getViews()) {
                ...
                this.addAttribute(node, "x", String.valueOf(((GUIObjectModel) t).getX(
                        (GUIViewModel) v)));
                this.addAttribute(node, "y", String.valueOf(((GUIObjectModel) t).getY(
                        (GUIViewModel) v)));
            }
        }
        return tablesNode;
