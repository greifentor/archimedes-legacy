/*
 * EditableSortedListSubEditor.java
 *
 * 11.06.2006
 *
 * (c) by ollie
 ...
 * <BR><B>archimedes.app.EditableSortedListSubEditor.create.frame</B> = Wird diese Property mit
 * dem Wert <TT>true</TT> belegt, so werden die EditorDjinns, die durch das Bet&auml;tigen des
 ...
 * <BR><B>archimedes.app.EditableSortedListSubEditor.edit.frame</B> = Wird diese Property mit
 * dem Wert <TT>true</TT> belegt, so werden die EditorDjinns, die durch das Bet&auml;tigen des
 ...
 *
 * @changed
 *     OLI 09.10.2007 - Umbau der Lockmechanismen f&uuml;r bearbeitete Elemente auf LockDjinns.
...
public class EditableSortedListSubEditor implements TableListSubEditor {
    ...
    /**
     * Generiert einen EditableSortedListSubEditor mit den &uuml;bergebenen Parametern.
     *
     ...
     * @param blueprint Eine Beispielinstanz der Klasse, die in dem Vector gespeichert sind oder
     ...
     *
     * @changed
     *     OLI 24.11.2008 - Ansicherung gegen eine NullPointerException, bei nicht gesetztem
     *             Frame in der ArchimedesApplication.
     *     <P>
     *
     */
    public EditableSortedListSubEditor(ArchimedesApplication app, Object sv, Object blueprint, 
            Object lo, NReferenzModel nrmodel, ArchimedesDynamic ad, 
            VectorPanelButtonFactory vpbf, String[] columnnames, boolean split, 
            boolean internalFrameEdit, Hashtable<String, Component> edpcomponents) {
        super();
        this.app = app;
        this.bp = blueprint;
        ...
        if ((app != null) && (app.getFrame() instanceof ComponentWithInifile)) {
        ...
        this.anzeige = new JTableWithInifile(new VectorTableModel(this.sv, columnnames), 
                this.ini, "EditableSortedListSubEditor-" + blueprint.getClass()) {
            public TableCellEditor getCellEditor(int row, int column) {
                VectorTableModel vtm = (VectorTableModel) this.getModel();
                Object o = vtm.getVector().elementAt(row);
                if ((o instanceof EditableColumnViewable) && (((EditableColumnViewable) o
                        ).getCellEditor(column) != null)) {
                    return ((EditableColumnViewable) o).getCellEditor(column);
                }
                return super.getCellEditor(row, column);
            }
            public TableCellRenderer getCellRenderer(int row, int column) {
                if ((bp instanceof ColumnViewable) && (((ColumnViewable) bp
                        ).getCellRenderer(column) != null)) {
    ...
    public void doButtonBearbeiten() {
        final EditableSortedListSubEditor eslse = this;
        if (this.anzeige.getSelectedRow() >= 0) {
            ...
            if (this.internalFrameEdit) {
                ...
                new InternalFrameEditorDjinn(
                    ...
                    public void doChanged(boolean saveOnly) {
                        try {
                            ...
                            if ((listowner instanceof SortedListSubEditorWatcher) 
                                    ...
                                    new SortedListSubEditorEventObject(eslse, attr, 
                    ...
                    "archimedes.app.EditableSortedListSubEditor.edit.frame")) {
                new DialogEditorDjinn(f, Utl.GetProperty(
                    ...
                    public void doChanged(boolean saveOnly) {
                        ...
                        if ((listowner instanceof SortedListSubEditorWatcher) 
                                && !((SortedListSubEditorWatcher) listowner).dataChanged(
                                new SortedListSubEditorEventObject(eslse, attr, edpcomponents, 
                ...
                new FrameEditorDjinn(StrUtil.FromHTML("&Auml;ndern " 
                    ...
                    public void doChanged(boolean saveOnly) {
                        sv.removeElement((Comparable) attr);
                        if ((listowner instanceof SortedListSubEditorMaster) 
                                && !((SortedListSubEditorMaster) listowner).isChangedObject(
                                nrm.getId(), sv, attr)) {
                            return;
    ...
    public void doButtonEinfuegen() {
        ...
        if (dsd.isSelected()) {
            ...
            if ((listowner instanceof SortedListSubEditorMaster) 
                    && !((SortedListSubEditorMaster) this.listowner).isInsertObject(nrm.getId(),
                    sv, selection)) {
                return;
            }
            for (int i = 0, len = selection.size(); i < len; i++) {
                ...
                if ((listowner instanceof SortedListSubEditorWatcher) 
                        && !((SortedListSubEditorWatcher) listowner).dataChanged(
                        new SortedListSubEditorEventObject(eslse, slctd, edpcomponents, 
    ...
    public void doButtonEntfernen() {
        ...
        if (this.anzeige.getSelectedRow() >= 0) {
            ...
            if ((this.listowner instanceof SortedListSubEditorMaster) 
                    && !((SortedListSubEditorMaster) listowner).isDeleteObject(this.nrm.getId(),
                    this.sv, obj)) {
                return;
            }
            if ((listowner instanceof SortedListSubEditorWatcher) 
                    && !((SortedListSubEditorWatcher) listowner).dataChanged(
                    new SortedListSubEditorEventObject(eslse, obj, edpcomponents, 
    ...
    public void doButtonNeuanlage() {
        ...
        if ((this.listowner instanceof SortedListSubEditorMaster)) {
            e = ((SortedListSubEditorMaster) listowner).afterCreateObject(this.nrm.getId(), e);
            if (e == null) {
                return;
            }
        }
        ...
        if (this.internalFrameEdit) {
            new InternalFrameEditorDjinn(
                    ApplicationObject.STANDARDAPP.getDesktop(), "Neuanlage " + titel, attr, 
                    false, (attr instanceof JasperReportable), this.ini, this.splitted, false) {
                public void doChanged(boolean saveOnly) {
                    try {
                        sv.removeElement(attr);
                        ApplicationObject.STANDARDAPP.getDFC().write(attr);
        ...
        } else if (!Boolean.getBoolean("archimedes.app.EditableSortedListSubEditor.create.frame"
                )) {
            new DialogEditorDjinn(f, Utl.GetProperty(
                    "archimedes.app.ListSubEditor.create.dialog." + e.getClass().getName() 
                    + ".title", "Neuanlage " + titel), attr, false, (attr instanceof 
                    HistoryWriter), this.ini, this.splitted, false, EditorDjinnMode.CREATE) {
                public void doClosed() {
                    doRepaint();
                }
                public void doChanged(boolean saveOnly) {
