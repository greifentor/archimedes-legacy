 ...
 * @changed OLI 18.05.2016 - Renamed to "ModelChecker" and changed return type of method <CODE>check()</CODE>.
 */

public interface ModelChecker {

	/**
	 * Checks a special problem an returns a string with a HTML problem description in case of an error is detected.
	 ...
	 *
	 * @changed OLI 28.01.2016 - Added.
	 * @changed OLI 18.05.2016 - Return type changed to an array of <CODE>ModelCheckerMessage</CODE>.
	 */
