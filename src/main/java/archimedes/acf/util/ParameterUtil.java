...
public class ParameterUtil {
	 ...
	 */
	@Deprecated
	public String getParameterStartsWith(String prefix, ColumnModel c) {
	 ...
	 */
	@Deprecated
	public String getParameterStartsWith(String prefix, TableModel t) {
	 ...
	 */
	@Deprecated
	public String getValueParameterStartsWith(String prefix, ColumnModel c) {
	 ...
	 */
	@Deprecated
	public String getValueParameterStartsWith(String prefix, TableModel tm) {
