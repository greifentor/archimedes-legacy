...
/**
 * An additional code checker which is executed after the code has been generated for the code
 * generator and table. It is only able to notify potential problems to the generation report.
 *
 * @author O.Lieshoff
 *
...
public interface AdditionalCodeChecker {
    ...
    abstract public void execute(GenerationProcessReport report, String fileName, String code, 
            ...
            CodeGenerator codeGenerator, TableModel tableModel);
