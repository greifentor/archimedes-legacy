...
public class TypeUtil {
     ...
     * @param referencesToKeyClass Set this flag, if references should be represented by keys
     *         only (if unset references are represented by Java pointers to referenced object.
     * @param timestampsWrapped Set this flag if fields of timestamp domains are to wrap by
     *         timestamp classes of the "corentx.dates" package.
     * @param entityGenerator Set this flag if the generator which calls the method is an
     ...
     */
    public String getJavaType(ColumnModel column, boolean referencesToKeyClass,
        ...
        if (column.getReferencedTable() != null) {
            return this.createTypeForReference(type, column, referencesToKeyClass,
                    timestampsWrapped, entityGenerator, parameterUtil, generatorUtil, imports);
     ...
     * @changed OLI 06.04.2016 - Added.
     */
    protected String createTypeForReference(String type, ColumnModel column,
            boolean referencesToKeyClass, boolean timestampsWrapped, boolean entityGenerator,
            ParameterUtil parameterUtil, CodeGeneratorUtil generatorUtil, ImportList imports) {
        return type;
    }

    /**
     * Returns the enum information for a domain (or <CODE>null</CODE> if the domain doesn't
     * provide those infos).
     *
     ...
     * @return The matching timestamp class or <CODE>null</CODE> of the domain is not matching
     *         a timestamp class.
     *
     * @changed OLI 29.05.2015 - Added comment.
     */
