...
public interface CodeGenerator {
    ...
    /**
     * A call of this method should create the code for the passed data model in the file
     * system.
     *
     ...
     * @return <CODE>true</CODE> if the code is generated correctly, <CODE>false</CODE>
     *         otherwise.
     *
     * @changed OLI 18.04.2013 - Added.
     */
    abstract public boolean generate(DataModel dm,
    ...
    /**
     * Checks if the code generator is deprecated and should only check for old source codes
     * while code generation.
     *
     * @return <CODE>false</CODE> if the code generator is vital and in use. Otherwise used only
     *         for deprecated source code file detection.
     *
     ...
     *
     * @return <CODE>true</CODE> if the factory is temporarily suspended from code generation
     *         process.
     *
     ...
     *
     * @param individualPreferences The individual preferences of the user for the code
     *         generator.
     *
    ...
    /**
     * Sets or resets the flag of temporarily suspension of the factory from code generation
     * process.
     *
