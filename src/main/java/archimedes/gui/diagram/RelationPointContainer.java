...
/**
 * Diese Klasse stellt eine Verbindung zwischen eine Relation und einem ihrer Punkte innerhalb
 * der Archimedes-Applikation her.
 *
 * @author
 *     O.Lieshoff
 *     <P>
...
public class RelationPointContainer {
    ...
    @Override public String toString() {
        if (this.relation != null) {
            ...
            return (o0 != null ? o0.getName() : "<null>") + " -> " + (o1 != null ? o1.getName()
                    : "<null>"); 
        }
        return "<null>";
    }
