...
/**
 * This interface has to be implemented by class which should be shown in a diagram GUI
 * component.
 *
 * @author O.Lieshoff
 *
...
public interface GUIObjectModel extends Comparable {
     ...
     * @changed OLI 14.05.2013 - Added.
     */
    abstract public ShapeContainer paintObject(CoordinateConverter converter, GUIViewModel view,
            Graphics graphics, PaintMode paintMode);
     ...
     * @changed OLI 14.05.2013 - Added.
     */
    abstract public ShapeContainer[] paintRelations(CoordinateConverter converter,
            GUIViewModel view, Graphics graphics, PaintMode paintMode);
