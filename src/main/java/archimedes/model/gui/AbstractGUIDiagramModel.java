...
abstract public class AbstractGUIDiagramModel implements GUIDiagramModel {
    ...
    private List<GUIDiagramModelListener> guiDiagramModelListeners =
            new Vector<GUIDiagramModelListener>();
    private List<GUIViewModel> views = new Vector<GUIViewModel>();

    /**
     * @changed OLI 23.05.2013 - Added.
     */
    @Override public void addView(GUIViewModel newView) {
     ...
     */
    @Override public void addGUIDiagramModelListener(GUIDiagramModelListener l) {
     ...
     * @changed OLI 23.05.2013 - Added.
     */
    @Override public void clearAltered() {
        this.altered = false;
    ...
    protected void fireGUIDiagramModelListenerStateChanged() {
        for (int i = 0, len = this.guiDiagramModelListeners.size(); i < len; i++) {
            try {
                ...
                LOG.error("an error occured while notifing : "
                        + e.getMessage());
            }
        }
    }
     ...
     */
    @Override public GUIViewModel getMainView() {
     ...
     * @changed OLI 23.05.2013 - Added.
     */
    @Override public GUIViewModel getView(String name) {
        for (GUIViewModel view : this.views) {
     ...
     * @changed OLI 23.05.2013 - Added.
     */
    @Override public List<GUIViewModel> getViewsForObject(String guiObjectName) {
     ...
     */
    @Override public boolean isAltered() {
        return this.altered;
    }
     ...
     * @changed OLI 23.05.2013 - Transfered from class <CODE>Diagramm</CODE>.
     */
    @Override public void raiseAltered() {
        this.altered = true;
        this.fireGUIDiagramModelListenerStateChanged();
    }
     ...
     * @changed OLI 22.05.2013 - Added.
     */
    @Override public void removeGUIDiagramModelListener(GUIDiagramModelListener l) {
