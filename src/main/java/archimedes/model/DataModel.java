...
import archimedes.model.events.*;
...
public interface DataModel extends CommentOwner, ComplexIndexListProvider,
        DatabaseConnectionProvider, DiagramGUISupport, GeneratorSupport, GUIDiagramModel,
        HistoryOwner, ImportSupport, OptionListProvider, SQLGeneratorSupport,
        StereotypeListProvider, UdschebtiSupport, ViewProvider {
    ...
    /**
     * Returns a script which is executed after a data model has been written to the file
     * system.
     *
     * @return A script which is executed after a data model has been written to the file
     *         system.
     *
     ...
     *
     * @return The basic package name for the application which should be created by the data
     *         model. If nothing is defined an empty string should be returned.
     *
     ...
     * @return The domain for the passed name or <CODE>null</CODE> if there is no domain for the
     *         passed name.
     *
     ...
     */
    @Deprecated abstract JDBCDataSourceRecord getImportDataSourceRecord();
     ...
     * @return The sequence with the passed name or <CODE>null</CODE> if there is no sequence
    ...
    /**
     * Returns the table model with the passed name or <CODE>null</CODE> if there is no table
     * with the passed name.
     *
     * @param name The name of the table which is to return.
     * @return the table model with the passed name or <CODE>null</CODE> if there is no table
     *         with the passed name.
     *
     * @changed OLI 25.04.2013 - Added.
     */
    ...
    /**
     * Returns an array with all tables of the model. In this array the tables are assorted
    ...
    /**
     * Sets a new script which is executed after a data model has been written to the file
     * system.
     *
     * @return script The new script which is executed after a data model has been written to
     *         the file system.
     *
     * @changed OLI 17.06.2016 - Added.
     */
